...
Proof .
    ...
    }
    {
        ...
        }
        {
            ...
            refine ( f _ ) .
            refine ( A_2024_09_15_0007@{ i i_次 } n_前 A x y ) .
        }
    }
Defined .
...
Proof .
    ...
    }
    {
        ...
        refine
            (
                列記型.依存型の場合分け@{ i_次 }
                    ...
                    (
                        fun y_1_ : 列記型@{ i } A =>
                        道@{ i } 自然数@{ i } ( 長さを求める@{ i } A y_1_ ) ( 後者関数@{ i } n_前 ) -> Type@{ i }
                    )
                    _
                    (
                        fun y_1_1 : A =>
        ...
        .
        {
            refine
                (
                    fun y_2 : 道@{ i } 自然数@{ i } ( 長さを求める@{ i } A ( 列記型.空の場合の構築子@{ i } A ) ) ( 後者関数@{ i } n_前 ) =>
                    _
                )
            .
            refine ( 終了する@{ i_次 } Type@{ i } _ ) .
            refine ( 鋳造@{ i_次 i_次_次 } 空型@{ i_次 } 単一型@{ i_次 } _ _ ) .
            {
                refine
                    (
                        let
