...
Definition A_2024_07_26_0006@{ i | } ( A : Type@{ i } ) ( x : A ) ( p : 片端自由道@{ i } A x ) : A
    := match p with A_2024_07_26_0005 _ _ y p_中身 => y end
.

(** 片端自由道を取り、そこから普通の道を得ます。 *)

Definition A_2024_07_26_0007@{ i | } ( A : Type@{ i } ) ( x : A ) ( p : 片端自由道@{ i } A x )
...
Definition A_2024_07_26_0008@{ i | } ( A : Type@{ i } ) ( x : A ) : 片端自由道@{ i } A x
