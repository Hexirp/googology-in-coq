...
Definition A_2024_07_21_0034@{ i | } : 自然数@{ i } := A_2024_07_21_0033@{ i } A_2024_07_21_0032@{ i } .

(** 二です。 *)

Definition A_2024_07_21_0035@{ i | } : 自然数@{ i } := A_2024_07_21_0033@{ i } A_2024_07_21_0034@{ i } .

(** 三です。 *)

Definition A_2024_07_21_0036@{ i | } : 自然数@{ i } := A_2024_07_21_0033@{ i } A_2024_07_21_0035@{ i } .

(** 四です。 *)

Definition A_2024_07_21_0037@{ i | } : 自然数@{ i } := A_2024_07_21_0033@{ i } A_2024_07_21_0036@{ i } .

(** 五です。 *)

Definition A_2024_07_21_0038@{ i | } : 自然数@{ i } := A_2024_07_21_0033@{ i } A_2024_07_21_0037@{ i } .

(** 六です。 *)

Definition A_2024_07_21_0039@{ i | } : 自然数@{ i } := A_2024_07_21_0033@{ i } A_2024_07_21_0038@{ i } .

(** 七です。 *)

Definition A_2024_07_21_0040@{ i | } : 自然数@{ i } := A_2024_07_21_0033@{ i } A_2024_07_21_0039@{ i } .

(** 八です。 *)

Definition A_2024_07_21_0041@{ i | } : 自然数@{ i } := A_2024_07_21_0033@{ i } A_2024_07_21_0040@{ i } .

(** 九です。 *)

Definition A_2024_07_21_0042@{ i | } : 自然数@{ i } := A_2024_07_21_0033@{ i } A_2024_07_21_0041@{ i } .

(** 十です。 *)

Definition A_2024_07_21_0043@{ i | } : 自然数@{ i } := A_2024_07_21_0033@{ i } A_2024_07_21_0042@{ i } .

(** 二を足します。 *)

Definition A_2024_07_21_0044@{ i | } ( x : 自然数@{ i } ) : 自然数@{ i }
    := A_2024_07_21_0033@{ i } ( A_2024_07_21_0033@{ i } x )
.

(** 三を足します。 *)

Definition A_2024_07_21_0045@{ i | } ( x : 自然数@{ i } ) : 自然数@{ i }
    := A_2024_07_21_0033@{ i } ( A_2024_07_21_0044@{ i } x )
.

(** 四を足します。 *)

Definition A_2024_07_21_0046@{ i | } ( x : 自然数@{ i } ) : 自然数@{ i }
    := A_2024_07_21_0033@{ i } ( A_2024_07_21_0045@{ i } x )
.

(** 五を足します。 *)

Definition A_2024_07_21_0047@{ i | } ( x : 自然数@{ i } ) : 自然数@{ i }
    := A_2024_07_21_0033@{ i } ( A_2024_07_21_0046@{ i } x )
.

(** 六を足します。 *)

Definition A_2024_07_21_0048@{ i | } ( x : 自然数@{ i } ) : 自然数@{ i }
    := A_2024_07_21_0033@{ i } ( A_2024_07_21_0047@{ i } x )
.

(** 七を足します。 *)

Definition A_2024_07_21_0049@{ i | } ( x : 自然数@{ i } ) : 自然数@{ i }
    := A_2024_07_21_0033@{ i } ( A_2024_07_21_0048@{ i } x )
.

(** 八を足します。 *)

Definition A_2024_07_21_0050@{ i | } ( x : 自然数@{ i } ) : 自然数@{ i }
    := A_2024_07_21_0033@{ i } ( A_2024_07_21_0049@{ i } x )
.

(** 九を足します。 *)

Definition A_2024_07_21_0051@{ i | } ( x : 自然数@{ i } ) : 自然数@{ i }
    := A_2024_07_21_0033@{ i } ( A_2024_07_21_0050@{ i } x )
.

(** 十を足します。 *)

Definition A_2024_07_21_0052@{ i | } ( x : 自然数@{ i } ) : 自然数@{ i }
    := A_2024_07_21_0033@{ i } ( A_2024_07_21_0051@{ i } x )
.

(** 足します。 *)

Definition A_2024_07_21_0053@{ i | } ( x : 自然数@{ i } ) ( y : 自然数@{ i } ) : 自然数@{ i }
    :=
        let
...
Definition A_2024_07_21_0054@{ i | } ( x : 自然数@{ i } ) ( y : 自然数@{ i } ) : 自然数@{ i }
    :=
        let
...
Definition A_2024_07_21_0055@{ i | } ( x : 自然数@{ i } ) ( y : 自然数@{ i } ) : 自然数@{ i }
    :=
        let
            fix a ( x : 自然数@{ i } ) ( y : 自然数@{ i } ) { struct y } : 自然数@{ i }
                :=
...
Definition A_2024_07_21_0060@{ i | } ( x : 自然数@{ i } ) ( y : 自然数@{ i } ) : 自然数@{ i }
    :=
        let
            fix a ( x : 自然数@{ i } ) ( y : 自然数@{ i } ) { struct y } : 自然数@{ i }
                :=
...
Definition A_2024_07_21_0056@{ i | } ( x : 自然数@{ i } ) ( y : 自然数@{ i } ) : 自然数@{ i }
    :=
        let
            fix a ( x : 自然数@{ i } ) ( y : 自然数@{ i } ) { struct x } : 自然数@{ i }
                :=
...
Definition A_2024_07_21_0057@{ i | } ( x : 自然数@{ i } ) ( y : 自然数@{ i } ) : 自然数@{ i }
    :=
        let
            fix a ( x : 自然数@{ i } ) ( y : 自然数@{ i } ) { struct x } : 自然数@{ i }
                :=
...
Definition A_2024_07_21_0058@{ i | } ( x : 自然数@{ i } ) : 自然数@{ i }
    :=
        let
...
Definition A_2024_07_21_0059@{ i | } ( x : 自然数@{ i } ) : 自然数@{ i }
    :=
        let
            fix a ( x : 自然数@{ i } ) { struct x } : 自然数@{ i }
                :=
...
Definition A_2024_07_21_0061@{ i | } ( x : 自然数@{ i } ) ( y : 自然数@{ i } ) : 自然数@{ i }
    :=
        let
            fix a ( x : 自然数@{ i } ) ( y : 自然数@{ i } ) { struct x } : 自然数@{ i }
                :=
...
Definition A_2024_07_21_0062@{ i | } ( x : 自然数@{ i } ) : 自然数@{ i }
    :=
        let
            fix a ( x : 自然数@{ i } ) ( y : 自然数@{ i } ) ( z : 自然数@{ i } ) { struct x }
                : 自然数@{ i }
                :=
                    match
                        x
...
Definition A_2024_08_02_0003@{ i | } ( x : 自然数@{ i } ) : 自然数@{ i }
    :=
        let
            fix a ( x : 自然数@{ i } ) ( y : 自然数@{ i } ) ( z : 自然数@{ i } ) { struct x }
                : 自然数@{ i }
...
Definition A_2024_08_26_0001@{ i | } ( m : 自然数@{ i } ) ( n : 自然数@{ i } )
    :
        A_2024_07_22_0009@{ i } 自然数@{ i } ( A_2024_07_21_0053@{ i } n m ) ( A_2024_07_21_0053@{ i } m n )
.
Proof .
    refine
        (
