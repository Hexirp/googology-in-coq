...
Definition ゼロの場合の構築子@{ i | } : 正の自然数@{ i } := A_2024_07_21_0064@{ i } .
...
Definition 場合分け@{ i | }
    ...
    ( 後者の場合の処理 : 正の自然数@{ i } -> 目標 )
    : 目標
    := A_2024_09_02_0001@{ i } 対象 目標 ゼロの場合の処理 後者の場合の処理
.
...
Definition A_2024_07_21_0066@{ i | } : 正の自然数@{ i } := A_2024_07_21_0065@{ i } A_2024_07_21_0064@{ i } .

(** 三です。 *)

Definition A_2024_07_21_0067@{ i | } : 正の自然数@{ i } := A_2024_07_21_0065@{ i } A_2024_07_21_0066@{ i } .

(** 四です。 *)

Definition A_2024_07_21_0068@{ i | } : 正の自然数@{ i } := A_2024_07_21_0065@{ i } A_2024_07_21_0067@{ i } .

(** 五です。 *)

Definition A_2024_07_21_0069@{ i | } : 正の自然数@{ i } := A_2024_07_21_0065@{ i } A_2024_07_21_0068@{ i } .

(** 六です。 *)

Definition A_2024_07_21_0070@{ i | } : 正の自然数@{ i } := A_2024_07_21_0065@{ i } A_2024_07_21_0069@{ i } .

(** 七です。 *)

Definition A_2024_07_21_0071@{ i | } : 正の自然数@{ i } := A_2024_07_21_0065@{ i } A_2024_07_21_0070@{ i } .

(** 八です。 *)

Definition A_2024_07_21_0072@{ i | } : 正の自然数@{ i } := A_2024_07_21_0065@{ i } A_2024_07_21_0071@{ i } .

(** 九です。 *)

Definition A_2024_07_21_0073@{ i | } : 正の自然数@{ i } := A_2024_07_21_0065@{ i } A_2024_07_21_0072@{ i } .

(** 十です。 *)

Definition A_2024_07_21_0074@{ i | } : 正の自然数@{ i } := A_2024_07_21_0065@{ i } A_2024_07_21_0073@{ i } .

(** 二を足します。 *)

Definition A_2024_07_21_0075@{ i | } ( x : 正の自然数@{ i } ) : 正の自然数@{ i }
    := A_2024_07_21_0065@{ i } ( A_2024_07_21_0065@{ i } x )
.

(** 三を足します。 *)

Definition A_2024_07_21_0076@{ i | } ( x : 正の自然数@{ i } ) : 正の自然数@{ i }
    := A_2024_07_21_0065@{ i } ( A_2024_07_21_0075@{ i } x )
.

(** 四を足します。 *)

Definition A_2024_07_21_0077@{ i | } ( x : 正の自然数@{ i } ) : 正の自然数@{ i }
    := A_2024_07_21_0065@{ i } ( A_2024_07_21_0076@{ i } x )
.

(** 五を足します。 *)

Definition A_2024_07_21_0078@{ i | } ( x : 正の自然数@{ i } ) : 正の自然数@{ i }
    := A_2024_07_21_0065@{ i } ( A_2024_07_21_0077@{ i } x )
.

(** 六を足します。 *)

Definition A_2024_07_21_0079@{ i | } ( x : 正の自然数@{ i } ) : 正の自然数@{ i }
    := A_2024_07_21_0065@{ i } ( A_2024_07_21_0078@{ i } x )
.

(** 七を足します。 *)

Definition A_2024_07_21_0080@{ i | } ( x : 正の自然数@{ i } ) : 正の自然数@{ i }
    := A_2024_07_21_0065@{ i } ( A_2024_07_21_0079@{ i } x )
.

(** 八を足します。 *)

Definition A_2024_07_21_0081@{ i | } ( x : 正の自然数@{ i } ) : 正の自然数@{ i }
    := A_2024_07_21_0065@{ i } ( A_2024_07_21_0080@{ i } x )
.

(** 九を足します。 *)

Definition A_2024_07_21_0082@{ i | } ( x : 正の自然数@{ i } ) : 正の自然数@{ i }
    := A_2024_07_21_0065@{ i } ( A_2024_07_21_0081@{ i } x )
.

(** 十を足します。 *)

Definition A_2024_07_21_0083@{ i | } ( x : 正の自然数@{ i } ) : 正の自然数@{ i }
    := A_2024_07_21_0065@{ i } ( A_2024_07_21_0082@{ i } x )
.

(** 足します。 *)

Definition A_2024_07_22_0000@{ i | } ( x : 正の自然数@{ i } ) ( y : 正の自然数@{ i } ) : 正の自然数@{ i }
    :=
        let
...
Definition A_2024_07_22_0001@{ i | } ( x : 正の自然数@{ i } ) ( y : 正の自然数@{ i } ) : 正の自然数@{ i }
    :=
        let
...
Definition A_2024_07_22_0004@{ i | } ( x : 正の自然数@{ i } ) ( y : 正の自然数@{ i } ) : 正の自然数@{ i }
    :=
        let
            fix a ( x : 正の自然数@{ i } ) ( y : 正の自然数@{ i } ) { struct x } : 正の自然数@{ i }
                :=
...
Definition A_2024_07_22_0005@{ i | } ( x : 正の自然数@{ i } ) ( y : 正の自然数@{ i } ) : 正の自然数@{ i }
    :=
        let
            fix a ( x : 正の自然数@{ i } ) ( y : 正の自然数@{ i } ) { struct x } : 正の自然数@{ i }
                :=
...
Definition A_2024_07_22_0006@{ i | } ( x : 正の自然数@{ i } ) : 正の自然数@{ i }
    :=
        let
...
Definition A_2024_07_22_0007@{ i | } ( x : 正の自然数@{ i } ) : 正の自然数@{ i }
    :=
        let
            fix a ( x : 正の自然数@{ i } ) { struct x } : 正の自然数@{ i }
                :=
...
Definition A_2024_07_22_0008@{ i | } ( x : 正の自然数@{ i } ) : 正の自然数@{ i }
    :=
        let
...
Definition A_2024_07_22_0022@{ i | } ( x : 正の自然数@{ i } ) ( y : 正の自然数@{ i } ) : A_2024_07_22_0016@{ i }
    :=
        let
            fix a ( x : 正の自然数@{ i } ) ( y : 正の自然数@{ i } ) { struct x } : A_2024_07_22_0016@{ i }
                :=
                    match
                        x , y
                    with
...
Definition A_2024_07_22_0023@{ i | } ( x : 正の自然数@{ i } ) ( y : 正の自然数@{ i } ) : A_2024_07_22_0016@{ i }
    :=
        let
            fix a ( x : 正の自然数@{ i } ) ( y : 正の自然数@{ i } ) { struct x } : A_2024_07_22_0016@{ i }
                :=
...
Definition A_2024_08_16_0005@{ i | } ( A : Type@{ i } ) ( x : A_2024_08_16_0000@{ i } A ) : 自然数@{ i }
    :=
        let
            fix a ( x_ : A_2024_08_16_0000@{ i } A ) { struct x_ } : 自然数@{ i }
                :=
                    match
                        x_
                    with
...
Definition A_2024_08_16_0006@{ i | } ( x : A_2024_08_16_0000@{ i } 自然数@{ i } ) : 自然数@{ i }
    :=
        let
            fix a ( x_ : A_2024_08_16_0000@{ i } 自然数@{ i } ) { struct x_ } : 自然数@{ i }
                :=
                    match
                        x_
                    with
                        A_2024_08_16_0001 _ => A_2024_07_21_0032@{ i }
                        |
                        A_2024_08_16_0002 _ x_1 x_2 => 足す@{ i } x_1 ( a x_2 )
                    end
        in
            a x
.
...
Definition A_2024_08_16_0007@{ i | } ( x : A_2024_08_16_0000@{ i } 自然数@{ i } ) : 自然数@{ i }
    :=
        let
            fix a ( x_ : A_2024_08_16_0000@{ i } 自然数@{ i } ) { struct x_ } : 自然数@{ i }
                :=
                    ...
                    with
                        ...
                        |
                        A_2024_08_16_0002 _ x_1 x_2 => 掛ける@{ i } x_1 ( a x_2 )
                    end
        in
            a x
.
