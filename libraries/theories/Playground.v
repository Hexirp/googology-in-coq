...
Definition A_2024_07_21_0028@{ i | } ( x : ブール型@{ i } ) : ブール型@{ i }
    := match x with A_2024_07_21_0026 => ブール型.真の場合の構築子@{ i } | A_2024_07_21_0027 => ブール型.偽の場合の構築子@{ i } end
.

(** 論理和です。 *)

Definition A_2024_07_21_0029@{ i | } ( x : ブール型@{ i } ) ( y : ブール型@{ i } ) : ブール型@{ i }
    :=
        match
            x , y
        with
            A_2024_07_21_0026 , A_2024_07_21_0026 => ブール型.偽の場合の構築子@{ i }
            |
            A_2024_07_21_0026 , A_2024_07_21_0027 => ブール型.真の場合の構築子@{ i }
            |
            A_2024_07_21_0027 , A_2024_07_21_0026 => ブール型.真の場合の構築子@{ i }
            |
            A_2024_07_21_0027 , A_2024_07_21_0027 => ブール型.真の場合の構築子@{ i }
        end
.

(** 論理積です。 *)

Definition A_2024_07_21_0030@{ i | } ( x : ブール型@{ i } ) ( y : ブール型@{ i } ) : ブール型@{ i }
    :=
    match
        x , y
    with
        A_2024_07_21_0026 , A_2024_07_21_0026 => ブール型.偽の場合の構築子@{ i }
        |
        A_2024_07_21_0026 , A_2024_07_21_0027 => ブール型.偽の場合の構築子@{ i }
        |
        A_2024_07_21_0027 , A_2024_07_21_0026 => ブール型.偽の場合の構築子@{ i }
        |
        A_2024_07_21_0027 , A_2024_07_21_0027 => ブール型.真の場合の構築子@{ i }
    end
.
