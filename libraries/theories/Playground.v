...
Definition 反転する@{ i | } ( A : Type@{ i } ) ( x : A ) ( y : A ) ( p : 道@{ i } A y x ) : 道@{ i } A x y
...
Definition A_2024_07_22_0028@{ i | } ( A : Type@{ i } ) ( x : A )
    :
        道@{ i }
            ( 道@{ i } A x x )
            ( 反転する@{ i } A x x ( A_2024_07_22_0010@{ i } A x ) )
            ( A_2024_07_22_0010@{ i } A x )
    := A_2024_07_22_0010@{ i } ( 道@{ i } A x x ) ( A_2024_07_22_0010@{ i } A x )
.
                        ...
                        道@{ i }
                            ...
                            (
                                結合する@{ i }
                                    ...
                                    y
                                    w
                                    ( 反転する@{ i } A w w ( A_2024_07_22_0010@{ i } A w ) )
                                    ( 反転する@{ i } A w y q_ )
                            )
                    := _
            in
                ...
                道@{ i }
                    ...
                    (
                        結合する@{ i }
                            ...
                            y_
                            w_
                            ( 反転する@{ i } A w_ w_ ( A_2024_07_22_0010@{ i } A w_ ) )
                            ( 反転する@{ i } A w_ y_ q__ )
                    )
            with
                A_2024_07_22_0010 _ v => _
...
Definition A_2024_07_26_0002@{ i | } ( A : Type@{ i } ) ( x : A ) ( y : A ) ( p : 道@{ i } A x y )
    ...
    :=
        ...
        return
            道@{ i }
                ( 道@{ i } A x_ y_ )
                ( 反転する@{ i } A x_ y_ ( 反転する@{ i } A y_ x_ p_ ) )
                p_
        with
            A_2024_07_22_0010 _ z => A_2024_07_22_0010@{ i } ( 道@{ i } A z z ) ( A_2024_07_22_0010@{ i } A z )
        end
...
Definition A_2024_07_26_0000@{ i | }
    ...
    :
        道@{ i }
            ( 道@{ i } A ( f x ) ( f y ) )
            ( A_2024_07_22_0013@{ i } A B f x y ( 反転する@{ i } B x y p ) )
            ( 反転する@{ i } A ( f x ) ( f y ) ( A_2024_07_22_0013@{ i } A B f y x p ) )
    :=
        match
            p
        as
        ...
        return
            道@{ i }
                ( 道@{ i } A ( f x_ ) ( f y_ ) )
                ( A_2024_07_22_0013@{ i } A B f x_ y_ ( 反転する@{ i } B x_ y_ p_ ) )
                ( 反転する@{ i } A ( f x_ ) ( f y_ ) ( A_2024_07_22_0013@{ i } A B f y_ x_ p_ ) )
        with
            A_2024_07_22_0010 _ z
