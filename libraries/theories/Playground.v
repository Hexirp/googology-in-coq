...
Definition A_2024_01_25_0000@{ i | } ( m : 自然数@{ i } ) : 道 自然数 ( 足す_自然数 m 零_自然数 ) m
    :=
        ...
        with
            零_構築子_自然数 => 恒等道_道 自然数 零_自然数
            |
            後者_構築子_自然数 m_p => 恒等道_道 自然数 ( 後者を計算する_自然数 m_p )
        end
.
...
Definition A_2024_01_25_0001@{ i | } ( n : 自然数@{ i } ) : 道 自然数 ( 足す_自然数 零_自然数 n ) n
    :=
        ...
        with
            零_構築子_自然数 => 恒等道_道 自然数 零_自然数
            |
            後者_構築子_自然数 n_p => 恒等道_道 自然数 ( 後者を計算する_自然数 n_p )
        end
.

Definition A_2024_01_25_0002@{ i | } ( m : 自然数@{ i } ) ( n : 自然数@{ i } )
    : 道 自然数 ( 足す_自然数 m ( 後者を計算する_自然数 n ) ) ( 後者を計算する_自然数 ( 足す_自然数 m n ) )
.
Proof.
    refine
        (
    ...
    -
        change
            (
                道
                    自然数
                    ( 足す_自然数 零_自然数 ( 後者を計算する_自然数 n ) )
                    ( 後者を計算する_自然数 ( 足す_自然数 零_自然数 n ) )
            )
        .
        change
            (
        ...
        .
        refine ( 関数を適用する_道 自然数 自然数 後者を計算する_自然数 n ( 足す_自然数 零_自然数 n ) _ ).
        refine ( 反転する_道 自然数 ( 足す_自然数 零_自然数 n ) n _ ).
        exact ( A_2024_01_25_0001 n ).
    -
        change
        (
            道
                自然数
                ( 足す_自然数 ( 後者を計算する_自然数 m_p ) ( 後者を計算する_自然数 n ) )
                ( 後者を計算する_自然数 ( 足す_自然数 ( 後者を計算する_自然数 m_p ) n ) )
        )
        .
        change
            (
                道
                    自然数
                    ( 後者を計算する_自然数 ( 後者を計算する_自然数 ( 足す_自然数 m_p n ) ) )
                    ( 後者を計算する_自然数 ( 足す_自然数 ( 後者を計算する_自然数 m_p ) n ) )
            )
        .
        exact _.
