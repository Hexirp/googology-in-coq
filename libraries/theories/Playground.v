...
Proof .
        ...
        (
            自然数.依存型の再帰@{ i }
                ...
                (
                    ...
                    forall y : 自然数@{ i } ,
                    forall z : 自然数@{ i } ,
                    道@{ i } 自然数@{ i } ( 和@{ i } ( 和@{ i } x_ y ) z ) ( 和@{ i } x_ ( 和@{ i } y z ) )
                )
                _
                (
                    fun x_前 : 自然数@{ i } =>
                    fun
                        a_前
                            :
                                forall y : 自然数@{ i } ,
                                forall z : 自然数@{ i } ,
                                道@{ i } 自然数@{ i } ( 和@{ i } ( 和@{ i } x_前 y ) z ) ( 和@{ i } x_前 ( 和@{ i } y z ) )
                    =>
                        _
                )
        )
    .
    {
            ...
            (
                自然数.依存型の場合分け@{ i }
                    ...
                    (
                        fun y_ : 自然数@{ i } =>
                        forall z : 自然数@{ i } ,
                        道@{ i } 自然数@{ i } ( 和@{ i } ( 和@{ i } ゼロ@{ i } y_ ) z ) ( 和@{ i } ゼロ@{ i } ( 和@{ i } y_ z ) )
                    )
                    _
                    ( fun y_前 : 自然数@{ i } => _ )
            )
                ...
                (
                    自然数.依存型の場合分け@{ i }
                        ...
                        (
                            ...
                            道@{ i }
                                自然数@{ i }
                                ( 和@{ i } ( 和@{ i } ゼロ@{ i } ゼロ@{ i } ) z_ )
                                ( 和@{ i } ゼロ@{ i } ( 和@{ i } ゼロ@{ i } z_ ) )
                        )
                        _
                        ( fun z_前 : 自然数@{ i } => _ )
                )
        ...
        }
        {
                ...
                (
                    自然数.依存型の場合分け@{ i }
                        ...
                        (
                            ...
                            道@{ i }
                                自然数@{ i }
                                ( 和@{ i } ( 和@{ i } ゼロ@{ i } ( 後者関数@{ i } y_前 ) ) z_ )
                                ( 和@{ i } ゼロ@{ i } ( 和@{ i } ( 後者関数@{ i } y_前 ) z_ ) )
                        )
                        _
                        ( fun z_前 : 自然数@{ i } => _ )
                )
            .
            {
                exact ( 恒等道@{ i } 自然数@{ i } ( 後者関数@{ i } y_前 ) ) .
            }
            {
                exact ( 恒等道@{ i } 自然数@{ i } ( 後者関数@{ i } ( 後者関数@{ i } ( 和@{ i } y_前 z_前 ) ) ) ) .
            }
        }
    }
    {
            ...
            (
                自然数.依存型の場合分け@{ i }
                    ...
                    (
                        ...
                        道@{ i }
                            自然数@{ i }
                            ( 和@{ i } ( 和@{ i } ( 後者関数@{ i } x_前 ) y_ ) z )
                            ( 和@{ i } ( 後者関数@{ i } x_前 ) ( 和@{ i } y_ z ) )
                    )
                    _
                    ( fun y_前 : 自然数@{ i } => _ )
            )
        .
        {
                ...
                (
                    自然数.依存型の場合分け@{ i }
                        ...
                        (
                            ...
                            道@{ i }
                                自然数@{ i }
                                ( 和@{ i } ( 和@{ i } ( 後者関数@{ i } x_前 ) ゼロ@{ i } ) z_ )
                                ( 和@{ i } ( 後者関数@{ i } x_前 ) ( 和@{ i } ゼロ@{ i } z_ ) )
                        )
                        _
                        ( fun z_前 : 自然数@{ i } => _ )
                )
            ...
            {
                exact ( 恒等道@{ i } 自然数@{ i } ( 後者関数@{ i } ( 後者関数@{ i } ( 和@{ i } x_前 z_前 ) ) ) ) .
            }
        }
        {
            refine ( fun z : 自然数@{ i } => _ ) .
                ...
                (
                    自然数.依存型の場合分け@{ i }
                        ...
                        (
                            ...
                            道@{ i }
                                自然数@{ i }
                                ( 和@{ i } ( 和@{ i } ( 後者関数@{ i } x_前 ) ( 後者関数@{ i } y_前 ) ) z_ )
                                ( 和@{ i } ( 後者関数@{ i } x_前 ) ( 和@{ i } ( 後者関数@{ i } y_前 ) z_ ) )
                        )
                        _
                        ( fun z_前 : 自然数@{ i } => _ )
                )
            .
            {
                exact ( 恒等道@{ i } 自然数@{ i } ( 後者関数@{ i } ( 後者関数@{ i } ( 和@{ i } x_前 y_前 ) ) ) ) .
            }
            {
                refine
                    (
                        等式推論の七@{ i }
                            自然数@{ i }
                            ( 和@{ i } ( 和@{ i } ( 後者関数@{ i } x_前 ) ( 後者関数@{ i } y_前 ) ) ( 後者関数@{ i } z_前 ) )
                            ( 和@{ i } ( 後者関数@{ i } ( 後者関数@{ i } ( 和@{ i } x_前 y_前 ) ) ) ( 後者関数@{ i } z_前 ) )
                            ( 後者関数@{ i } ( 後者関数@{ i } ( 和@{ i } ( 後者関数@{ i } ( 和@{ i } x_前 y_前 ) ) z_前 ) ) )
                            ( 後者関数@{ i } ( 後者関数@{ i } ( 後者関数@{ i } ( 和@{ i } ( 和@{ i } x_前 y_前 ) z_前 ) ) ) )
                            ( 後者関数@{ i } ( 後者関数@{ i } ( 後者関数@{ i } ( 和@{ i } x_前 ( 和@{ i } y_前 z_前 ) ) ) ) )
                            ( 後者関数@{ i } ( 後者関数@{ i } ( 和@{ i } x_前 ( 後者関数@{ i } ( 和@{ i } y_前 z_前 ) ) ) ) )
                            ( 和@{ i } ( 後者関数@{ i } x_前 ) ( 後者関数@{ i } ( 後者関数@{ i } ( 和@{ i } y_前 z_前 ) ) ) )
                            ( 和@{ i } ( 後者関数@{ i } x_前 ) ( 和@{ i } ( 後者関数@{ i } y_前 ) ( 後者関数@{ i } z_前 ) ) )
                            _
                            _
                            _
                            _
                    ...
                    refine
                        (
                            適用@{ i }
                                自然数@{ i }
                                自然数@{ i }
                                ( fun w : 自然数@{ i } => 後者関数@{ i } ( 後者関数@{ i } w ) )
                                ( 和@{ i } ( 後者関数@{ i } ( 和@{ i } x_前 y_前 ) ) z_前 )
                                ( 後者関数@{ i } ( 和@{ i } ( 和@{ i } x_前 y_前 ) z_前 ) )
                                _
                        )
                    .
                    exact ( 甲の後者と乙の和と甲と乙の和の後者は等しい@{ i } ( 和@{ i } x_前 y_前 ) z_前 ) .
                }
                {
                    refine
                        (
                            適用@{ i }
                                自然数@{ i }
                                自然数@{ i }
                                ( fun w : 自然数@{ i } => 後者関数@{ i } ( 後者関数@{ i } ( 後者関数@{ i } w ) ) )
                                ( 和@{ i } ( 和@{ i } x_前 y_前 ) z_前 )
                                ( 和@{ i } x_前 ( 和@{ i } y_前 z_前 ) )
                                _
                        )
                ...
                }
                {
                    refine
                        (
                            適用@{ i }
                                ...
                                自然数@{ i }
                                ( fun w : 自然数@{ i } => 後者関数@{ i } ( 後者関数@{ i } w ) )
                                ( 後者関数@{ i } ( 和@{ i } x_前 ( 和@{ i } y_前 z_前 ) ) )
                                ( 和@{ i } x_前 ( 後者関数@{ i } ( 和@{ i } y_前 z_前 ) ) )
                                _
                        )
                    .
                    refine
                    ...
                    .
                    exact ( 甲と乙の後者の和と甲と乙の和の後者は等しい@{ i } x_前 ( 和@{ i } y_前 z_前 ) ) .
                }
                {
                    exact
                        (
...
Proof .
    ...
    refine
        (
            自然数.依存型の再帰@{ i }
                x
                ( fun x_ : 自然数@{ i } => forall y : 自然数@{ i } , 道@{ i } 自然数@{ i } ( 和@{ i } x_ y ) ( 和@{ i } y x_ ) )
                _
                (
                    fun x_前 : 自然数@{ i } =>
                    fun a_前 : forall y : 自然数@{ i } , 道@{ i } 自然数@{ i } ( 和@{ i } x_前 y ) ( 和@{ i } y x_前 ) =>
                    _
                )
        )
    .
    {
        ...
        refine
            (
                自然数.依存型の場合分け@{ i }
                    y
                    ( fun y_ : 自然数@{ i } => 道@{ i } 自然数@{ i } ( 和@{ i } ゼロ@{ i } y_ ) ( 和@{ i } y_ ゼロ@{ i } ) )
                    _
                    ( fun y_前 : 自然数@{ i } => _ )
            )
        .
        ...
        refine
            (
                自然数.依存型の場合分け@{ i }
                    ...
                    (
                        fun y_ : 自然数@{ i } =>
                        道@{ i } 自然数@{ i } ( 和@{ i } ( 後者関数@{ i } x_前 ) y_ ) ( 和@{ i } y_ ( 後者関数@{ i } x_前 ) )
                    )
                    _
                    ( fun y_前 : 自然数@{ i } => _ )
            )
        ...
        }
        {
            refine
                (
                    等式推論の三@{ i }
                        自然数@{ i }
                        ( 和@{ i } ( 後者関数@{ i } x_前 ) ( 後者関数@{ i } y_前 ) )
                        ( 後者関数@{ i } ( 後者関数@{ i } ( 和@{ i } x_前 y_前 ) ) )
                        ( 後者関数@{ i } ( 後者関数@{ i } ( 和@{ i } y_前 x_前 ) ) )
                        ( 和@{ i } ( 後者関数@{ i } y_前 ) ( 後者関数@{ i } x_前 ) )
                        _
                        _
                        _
                )
            ...
            {
                exact ( 恒等道@{ i } 自然数@{ i } ( 後者関数@{ i } ( 後者関数@{ i } ( 和@{ i } y_前 x_前 ) ) ) ) .
            }
        }
    }
Defined .
