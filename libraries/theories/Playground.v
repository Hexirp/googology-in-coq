...
Definition A_2024_07_22_0020@{ i | } ( x : 整数@{ i } ) : 整数@{ i }
    :=
        match
            x
        with
...
Definition A_2024_07_22_0021@{ i | } ( x : 整数@{ i } ) : 整数@{ i }
    :=
        match
            x
        with
...
Definition A_2024_07_22_0022@{ i | } ( x : 正の自然数@{ i } ) ( y : 正の自然数@{ i } ) : 整数@{ i }
    :=
        let
...
Definition A_2024_07_22_0023@{ i | } ( x : 正の自然数@{ i } ) ( y : 正の自然数@{ i } ) : 整数@{ i }
    :=
        let
            fix a ( x : 正の自然数@{ i } ) ( y : 正の自然数@{ i } ) { struct x } : 整数@{ i }
                :=
...
Definition A_2024_07_22_0024@{ i | } ( x : 整数@{ i } ) ( y : 整数@{ i } ) : 整数@{ i }
    :=
        match
            x , y
        with
...
Definition A_2024_07_22_0025@{ i } ( x : 整数@{ i } ) : 整数@{ i }
    :=
        match
            x
        with
...
Definition A_2024_07_22_0026@{ i | } ( x : 整数@{ i } ) ( y : 整数@{ i } ) : 整数@{ i }
    :=
        match
            x , y
        with
