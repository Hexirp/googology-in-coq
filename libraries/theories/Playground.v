...
Definition A_2024_07_22_0001@{ i | } : 正の自然数@{ i } -> 正の自然数@{ i } -> 正の自然数@{ i }
    :=
        ...
        正の自然数.再帰@{ i }
            ...
            正の自然数@{ i }
            x
            ( fun y_前 : 正の自然数@{ i } => fun a_前 : 正の自然数@{ i } => A_2024_07_22_0000@{ i } x a_前 )
.
...
Definition A_2024_07_22_0006@{ i | } : 正の自然数@{ i } -> 正の自然数@{ i }
    :=
        ...
        正の自然数.再帰@{ i }
            ...
            正の自然数@{ i }
            一@{ i }
            ( fun x_前 : 正の自然数@{ i } => fun a_前 : 正の自然数@{ i } => A_2024_07_22_0000@{ i } ( 後者関数@{ i } x_前 ) a_前 )
.
...
Definition A_2024_07_22_0007@{ i | } : 正の自然数@{ i } -> 正の自然数@{ i }
    :=
        ...
        正の自然数.再帰@{ i }
            ...
            正の自然数@{ i }
            一@{ i }
            ( fun x_前 : 正の自然数@{ i } => fun a_前 : 正の自然数@{ i } => A_2024_07_22_0001@{ i } ( 後者関数@{ i } x_前 ) a_前 )
.
        ...
        整数.場合分け@{ i }
            ...
            (
                ...
                整数.場合分け@{ i }
                    y
                    整数@{ i }
                    ( fun y_負 : 正の自然数@{ i } => 整数.負の場合の構築子@{ i } ( A_2024_07_22_0000@{ i } x_負 y_負 ) )
                    ( 整数.負の場合の構築子@{ i } x_負 )
            ...
            (
                ...
                整数.場合分け@{ i }
                    ...
                    ( 整数.正の場合の構築子@{ i } x_正 )
                    ( fun y_正 : 正の自然数@{ i } => 整数.正の場合の構築子@{ i } ( A_2024_07_22_0000@{ i } x_正 y_正 ) )
            )
.
        ...
        整数.場合分け@{ i }
            ...
            (
                ...
                整数.場合分け@{ i }
                    y
                    整数@{ i }
                    ( fun y_負 : 正の自然数@{ i } => 整数.正の場合の構築子@{ i } ( A_2024_07_22_0001@{ i } x_負 y_負 ) )
                    整数.ゼロの場合の構築子
                    ( fun y_正 : 正の自然数@{ i } => 整数.負の場合の構築子@{ i } ( A_2024_07_22_0001@{ i } x_負 y_正 ) )
            )
            (
                fun y : 整数@{ i } =>
                整数.場合分け@{ i }
            ...
            (
                ...
                整数.場合分け@{ i }
                    y
                    整数@{ i }
                    ( fun y_負 : 正の自然数@{ i } => 整数.負の場合の構築子@{ i } ( A_2024_07_22_0001@{ i } x_正 y_負 ) )
                    整数.ゼロの場合の構築子
                    ( fun y_正 : 正の自然数@{ i } => 整数.正の場合の構築子@{ i } ( A_2024_07_22_0001@{ i } x_正 y_正 ) )
            )
.
...
Definition A_2024_09_06_0001@{ i | }
    ...
    :=
        ...
        with
            ...
            |
            A_2024_08_16_0002 _ x_1 x_2 => 節の場合の処理 x_1 x_2
        end
.
...
Definition A_2024_09_06_0002@{ i | }
    :
        ...
        目標 ( 空の場合の構築子@{ i } A )
        ->
        ( forall x_1 : A , forall x_2 : 列記型@{ i } A , 目標 ( 節の場合の構築子@{ i } A x_1 x_2 ) )
        ->
        目標 対象
    :=
        fun A : Type@{ i } =>
        ...
        fun 節の場合の処理 : forall x_1 : A , forall x_2 : 列記型@{ i } A , 目標 ( 節の場合の構築子@{ i } A x_1 x_2 ) =>
        match
            対象
        as
            対象_
...
Definition 依存型の場合分け@{ i | }
    ...
    ( 節の場合の処理 : forall x_1 : A , forall x_2 : 列記型@{ i } A , 目標 ( 節の場合の構築子@{ i } A x_1 x_2 ) )
    : 目標 対象
            ...
            fix a ( 対象_ : 列記型@{ i } A ) { struct 対象_ } : 目標
                :=
                    場合分け@{ i }
                        ...
                        目標
                        空の場合の処理
                        ( fun x_1 : A => fun x_2 : 列記型@{ i } A => 節の場合の処理 x_1 x_2 ( a x_2 ) )
        )
            対象
.
...
Definition A_2024_08_16_0005@{ i | } ( A : Type@{ i } ) ( x : 列記型@{ i } A ) : 自然数@{ i }
    :=
        let
            fix a ( x_ : 列記型@{ i } A ) { struct x_ } : 自然数@{ i }
                :=
                    match
                        x_
                    with
...
Definition A_2024_08_16_0006@{ i | } ( x : 列記型@{ i } 自然数@{ i } ) : 自然数@{ i }
    :=
        let
            fix a ( x_ : 列記型@{ i } 自然数@{ i } ) { struct x_ } : 自然数@{ i }
                :=
                    match
                        x_
                    with
...
Definition A_2024_08_16_0007@{ i | } ( x : 列記型@{ i } 自然数@{ i } ) : 自然数@{ i }
    :=
        let
            fix a ( x_ : 列記型@{ i } 自然数@{ i } ) { struct x_ } : 自然数@{ i }
                :=
...
Definition A_2024_08_16_0008@{ i | } ( A : Type@{ i } ) ( x : 列記型@{ i } A ) ( y : 列記型@{ i } A )
    : 列記型@{ i } A
    :=
        let
            fix a ( x_ : 列記型@{ i } A ) ( y_ : 列記型@{ i } A ) { struct x_ } : 列記型@{ i } A
                :=
                    match
                        x_
                    with
...
Definition A_2024_08_16_0009@{ i | } ( A : Type@{ i } ) ( x : 列記型@{ i } ( 列記型@{ i } A ) )
    : 列記型@{ i } A
    :=
        let
            fix a ( x_ : 列記型@{ i } ( 列記型@{ i } A ) ) { struct x_ } : 列記型@{ i } A
                :=
                    match
                        x_
                    with
...
Definition A_2024_08_16_0010@{ i | } ( A : Type@{ i } ) ( x : 列記型@{ i } A ) : 列記型@{ i } A
    :=
        let
            fix a ( x_ : 列記型@{ i } A ) ( y : 列記型@{ i } A ) { struct x_ } : 列記型@{ i } A
                :=
                    match
                        x_
                    with
