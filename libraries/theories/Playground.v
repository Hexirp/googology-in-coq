...
Definition 二_正の自然数@{ i | } : 正の自然数@{ i } := 後者_構築子_正の自然数 一_正の自然数.

Definition 三_正の自然数@{ i | } : 正の自然数@{ i } := 後者_構築子_正の自然数 二_正の自然数.

Definition 四_正の自然数@{ i | } : 正の自然数@{ i } := 後者_構築子_正の自然数 三_正の自然数.

Definition 五_正の自然数@{ i | } : 正の自然数@{ i } := 後者_構築子_正の自然数 四_正の自然数.

Definition 六_正の自然数@{ i | } : 正の自然数@{ i } := 後者_構築子_正の自然数 五_正の自然数.

Definition 七_正の自然数@{ i | } : 正の自然数@{ i } := 後者_構築子_正の自然数 六_正の自然数.

Definition 八_正の自然数@{ i | } : 正の自然数@{ i } := 後者_構築子_正の自然数 七_正の自然数.

Definition 九_正の自然数@{ i | } : 正の自然数@{ i } := 後者_構築子_正の自然数 八_正の自然数.

Definition 十_正の自然数@{ i | } : 正の自然数@{ i } := 後者_構築子_正の自然数 九_正の自然数.
