...
Definition 構築子@{ i | } ( A : Type@{ i } ) ( x : A -> 空型@{ i } ) : A_2024_08_01_0001@{ i } A := A_2024_08_01_0002@{ i } A x .
...
Definition A_2024_08_01_0004@{ i } ( A : Type@{ i } ) ( B : Type@{ i } ) ( f : A -> B ) ( x : 否定型@{ i } B )
    : 否定型@{ i } A
    := 否定型.構築子@{ i } A ( fun y : A => A_2024_08_01_0003@{ i } B x ( f y ) )
.
...
.
Proof .
    refine ( 否定型.構築子@{ i } ( 否定型@{ i } ( A_2024_07_21_0005@{ i } ( A -> B ) ( B -> A ) ) ) _ ) .
    refine
        (
            let
...
.
Proof .
    refine ( 否定型.構築子@{ i } ( 否定型@{ i } ( A_2024_07_21_0005@{ i } A ( 否定型@{ i } A ) ) ) _ ) .
    refine
        (
            let
...
Proof .
    ...
    }
    {
        ...
        .
        refine ( 否定型.構築子@{ i } ( 否定型@{ i } ( A_2024_07_21_0013@{ i } A B ) ) _ ) .
        refine
            (
                let
...
Proof .
    ...
    .
    {
        ...
        .
        refine ( 否定型.構築子@{ i } ( A_2024_07_21_0013@{ i } ( 否定型@{ i } A ) ( 否定型@{ i } B ) ) _ ) .
        refine
            (
                let
        ...
        refine ( 否定型.構築子@{ i } ( A_2024_07_21_0005@{ i } A B ) _ ) .
        refine
            (
                let
    ...
    }
    {
        ...
        .
        refine ( 否定型.構築子@{ i } ( 否定型@{ i } ( A_2024_07_21_0005@{ i } A B ) ) _ ) .
        refine
            (
                let
