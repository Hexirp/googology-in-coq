...
Ltac a_2024_09_19_0000 i A w x y z := refine ( 結合@{ i } A w z x _ ( 結合@{ i } A x z y _ _ ) ) .

(** 等式推論の証明戦術です。 *)

Ltac a_2024_09_19_0001 i A u v w x y z
    := refine ( 結合@{ i } A u z v _ ( 結合@{ i } A v z w _ ( 結合@{ i } A w z x _ ( 結合@{ i } A x z y _ _ ) ) ) )
.
...
(** 型と値の組に関するモジュールを定義します。 *)

Module A_2024_09_18_0004 .

(** 型と値の組です。 *)

Inductive A_2024_09_18_0005@{ i i_次 | i < i_次 } : Type@{ i_次 }
    := A_2024_09_18_0006 : forall A : Type@{ i } , A -> A_2024_09_18_0005
.

Module A_2024_09_18_0005 .

Definition 構築子@{ i i_次 | i < i_次 } ( A : Type@{ i } ) ( x : A ) : A_2024_09_18_0005@{ i i_次 }
    := A_2024_09_18_0006@{ i i_次 } A x
.

(** 場合分けです。 *)

Definition A_2024_09_18_0007@{ i i_次 | i < i_次 }
    : A_2024_09_18_0005@{ i i_次 } -> forall 目標 : Type@{ i_次 } , ( forall A : Type@{ i } , A -> 目標 ) -> 目標
    :=
        fun 対象 : A_2024_09_18_0005@{ i i_次 } =>
        fun 目標 : Type@{ i_次 } =>
        fun 処理 : forall A : Type@{ i } , A -> 目標 =>
        match
            対象
        with
            A_2024_09_18_0006 対象_型 対象_値 => 処理 対象_型 対象_値
        end
.

Definition 場合分け@{ i i_次 | i < i_次 }
    ( 対象 : A_2024_09_18_0005@{ i i_次 } )
    ( 目標 : Type@{ i_次 } )
    ( 処理 : forall A : Type@{ i } , A -> 目標 )
    : 目標
    := A_2024_09_18_0007@{ i i_次 } 対象 目標 処理
.

(** 依存型の場合分けです。 *)

Definition A_2024_09_18_0008@{ i i_次 | i < i_次 }
    :
        forall 対象 : A_2024_09_18_0005@{ i i_次 } ,
        forall 目標 : A_2024_09_18_0005@{ i i_次 } -> Type@{ i_次 } ,
        ( forall A : Type@{ i } , forall x : A , 目標 ( 構築子@{ i i_次 } A x ) )
        ->
        目標 対象
    :=
        fun 対象 : A_2024_09_18_0005@{ i i_次 } =>
        fun 目標 : A_2024_09_18_0005@{ i i_次 } -> Type@{ i_次 } =>
        fun 処理 : forall A : Type@{ i } , forall x : A , 目標 ( 構築子@{ i i_次 } A x ) =>
        match
            対象
        as
            対象_
...
Definition 依存型の場合分け@{ i i_次 | i < i_次 }
    ( 対象 : A_2024_09_18_0005@{ i i_次 } )
    ( 目標 : A_2024_09_18_0005@{ i i_次 } -> Type@{ i_次 } )
    ( 処理 : forall A : Type@{ i } , forall x : A , 目標 ( 構築子@{ i i_次 } A x ) )
    : 目標 対象
    := A_2024_09_18_0008@{ i i_次 } 対象 目標 処理
.

End A_2024_09_18_0005 .

Definition A_2024_09_18_0009@{ i i_次 | i < i_次 } : A_2024_09_18_0005@{ i i_次 } -> Type@{ i }
    :=
        fun 対象 : A_2024_09_18_0005@{ i i_次 } =>
        A_2024_09_18_0005.場合分け@{ i i_次 }
            対象
            Type@{ i }
            ( fun 対象_型 : Type@{ i } => fun 対象_値 : 対象_型 => 対象_型 )
.

End A_2024_09_18_0004 .

(** ** 固定長列記型 *)

(** 固定長列記型に関するモジュールを定義します。 *)

Module A_2024_09_15_0000 .
...
Inductive A_2024_09_15_0001@{ i | } ( n : 自然数@{ i } ) ( A : Type@{ i } ) : Type@{ i }
    := A_2024_09_15_0002 : forall x : 列記型@{ i } A , 道@{ i } 自然数@{ i } ( 長さを求める@{ i } A x ) n -> A_2024_09_15_0001 n A
.

Definition 固定長列記型@{ i | } ( n : 自然数@{ i } ) ( A : Type@{ i } ) : Type@{ i } := A_2024_09_15_0001@{ i } n A .

Module A_2024_09_15_0001 .

Definition 構築子@{ i | }
    ( n : 自然数@{ i } )
    ( A : Type@{ i } )
    ( x_1 : 列記型@{ i } A )
    ( x_2 : 道@{ i } 自然数@{ i } ( 長さを求める@{ i } A x_1 ) n )
    : 固定長列記型@{ i } n A
    := A_2024_09_15_0002@{ i } n A x_1 x_2
.

(** 固定長列記型について場合分けします。 *)

Definition A_2024_09_15_0003@{ i | }
    :
        forall n : 自然数@{ i } ,
        forall A : Type@{ i } ,
        固定長列記型@{ i } n A
        ->
        forall 目標 : Type@{ i } ,
        ( forall 対象_1 : 列記型@{ i } A , 道@{ i } 自然数@{ i } ( 長さを求める@{ i } A 対象_1 ) n -> 目標 )
        ->
        目標
    :=
        fun n : 自然数@{ i } =>
        ...
        fun 対象 : 固定長列記型@{ i } n A =>
        fun 目標 : Type@{ i } =>
        fun 処理 : forall 対象_1 : 列記型@{ i } A , 道@{ i } 自然数@{ i } ( 長さを求める@{ i } A 対象_1 ) n -> 目標 =>
        match 対象 with A_2024_09_15_0002 _ _ 対象_1 対象_2 => 処理 対象_1 対象_2 end
.
...
Definition 場合分け@{ i | }
    ...
    ( 対象 : 固定長列記型@{ i } n A )
    ( 目標 : Type@{ i } )
    ( 処理 : forall 対象_1 : 列記型@{ i } A , 道@{ i } 自然数@{ i } ( 長さを求める@{ i } A 対象_1 ) n -> 目標 )
    : 目標
    := A_2024_09_15_0003@{ i } n A 対象 目標 処理
.

(** 固定長列記型について依存型の場合分けをします。 *)

Definition A_2024_09_15_0004@{ i | }
    :
        forall n : 自然数@{ i } ,
        forall A : Type@{ i } ,
        forall 対象 : 固定長列記型@{ i } n A ,
        forall 目標 : 固定長列記型@{ i } n A -> Type@{ i } ,
        (
            forall 対象_1 : 列記型@{ i } A ,
            forall 対象_2 : 道@{ i } 自然数@{ i } ( 長さを求める@{ i } A 対象_1 ) n ,
            目標 ( 構築子@{ i } n A 対象_1 対象_2 )
        )
        ->
        目標 対象
    :=
        ...
        return
            目標 対象_
        with
            A_2024_09_15_0002 _ _ 対象_1 対象_2 => 処理 対象_1 対象_2
        end
.
...
Definition 依存型の場合分け@{ i | }
    ...
    : 目標 対象
    := A_2024_09_15_0004@{ i } n A 対象 目標 処理
.

End A_2024_09_15_0001 .

Module 固定長列記型 := A_2024_09_15_0001 .

(** 空の列記を作成します。 *)

Definition A_2024_09_15_0006@{ i | } : forall A : Type@{ i } , 固定長列記型@{ i } ゼロ@{ i } A .
Proof .
    refine ( fun A : Type@{ i } => _ ) .
    refine ( 固定長列記型.構築子@{ i } ゼロ@{ i } A ( 列記型.空の場合の構築子@{ i } A ) _ ) .
    exact ( 恒等道@{ i } 自然数@{ i } ゼロ@{ i } ) .
Defined .

(** 追加します。 *)

Definition A_2024_09_15_0007@{ i i_次 | i < i_次 }
    : forall n : 自然数@{ i } , forall A : Type@{ i } , A -> 固定長列記型@{ i } n A -> 固定長列記型@{ i } ( 後者関数@{ i } n ) A
.
Proof .
    refine ( fun n : 自然数@{ i } => _ ) .
    refine ( fun A : Type@{ i } => _ ) .
    refine ( fun x : A => _ ) .
    refine ( fun y : 固定長列記型@{ i } n A => _ ) .
    refine
        (
            固定長列記型.場合分け@{ i }
                n
                ...
                (
                    fun y_1 : 列記型@{ i } A =>
                    fun y_2 : 道@{ i } 自然数@{ i } ( 長さを求める@{ i } A y_1 ) n =>
                    _
                )
        )
    .
    refine ( 固定長列記型.構築子@{ i } ( 後者関数@{ i } n ) A ( 列記型.節の場合の構築子 A x y_1 ) _ ) .
    refine
        (
            鋳造@{ i i_次 }
                (
                    道@{ i }
                        自然数@{ i }
                        ( 長さを求める@{ i } A ( 列記型.節の場合の構築子@{ i } A x y_1 ) )
                        ( 後者関数@{ i } n )
                )
                ( 道@{ i } 自然数@{ i } ( 後者関数@{ i } ( 長さを求める@{ i } A y_1 ) ) ( 後者関数@{ i } n ) )
                _
                _
        )
    .
    ...
    {
        refine ( 適用@{ i } 自然数@{ i } 自然数@{ i } 後者関数@{ i } ( 長さを求める@{ i } A y_1 ) n _ ) .
        exact y_2 .
    }
Defined .
...
Definition A_2024_09_16_0002@{ i i_次 | i < i_次 }
    :
        forall n : 自然数@{ i } ,
        forall A : Type@{ i } ,
        固定長列記型@{ i } ( 後者関数@{ i } n ) A
        ->
        直積型@{ i } A ( 固定長列記型@{ i } n A )
.
Proof .
    refine ( fun n : 自然数@{ i } => _ ) .
    refine ( fun A : Type@{ i } => _ ) .
    refine ( fun x : 固定長列記型@{ i } ( 後者関数@{ i } n ) A => _ ) .
    refine
        (
            固定長列記型.場合分け@{ i }
                ( 後者関数@{ i } n )
    ...
    refine
        (
            列記型.依存型の場合分け@{ i }
                ...
                (
                    fun x_1_ : 列記型@{ i } A =>
                    道@{ i } 自然数@{ i } ( 長さを求める@{ i } A x_1_ ) ( 後者関数@{ i } n ) -> 直積型@{ i } A ( 固定長列記型@{ i } n A )
                )
                _
                ( fun x_1_1 : A => fun x_1_2 : 列記型@{ i } A => _ )
        )
    .
    {
        refine
            (
                鋳造@{ i i_次 }
                    (
                        道@{ i } 自然数@{ i } ( 長さを求める@{ i } A ( 列記型.空の場合の構築子@{ i } A ) ) ( 後者関数@{ i } n )
                        ->
                        直積型@{ i } A ( 固定長列記型@{ i } n A )
                    )
                    (
                        道@{ i } 自然数@{ i } ゼロ@{ i } ( 後者関数@{ i } n )
                        ->
                        直積型@{ i } A ( 固定長列記型@{ i } n A )
                    )
                    _
        ...
        .
        {
            exact
                (
                    恒等道@{ i_次 }
                        Type@{ i }
                        ( 道@{ i } 自然数@{ i } ゼロ@{ i } ( 後者関数@{ i } n ) -> 直積型@{ i } A ( 固定長列記型@{ i } n A ) )
                )
            .
        }
        {
            refine ( fun x_2 : 道@{ i } 自然数@{ i } ゼロ@{ i } ( 後者関数@{ i } n ) => _ ) .
            refine ( 終了する@{ i } ( 直積型@{ i } A ( 固定長列記型@{ i } n A ) ) _ ) .
            refine ( 鋳造@{ i i_次 } 空型@{ i } 単一型@{ i } _ _ ) .
            {
                refine
                    (
                        let
    ...
    }
    {
        refine
            (
                鋳造@{ i i_次 }
                    (
                        道@{ i } 自然数@{ i } ( 長さを求める@{ i } A ( 列記型.節の場合の構築子@{ i } A x_1_1 x_1_2 ) ) ( 後者関数@{ i } n )
                        ->
                        直積型@{ i } A ( 固定長列記型@{ i } n A )
                    )
                    (
                        道@{ i } 自然数@{ i } ( 後者関数@{ i } ( 長さを求める@{ i } A x_1_2 ) ) ( 後者関数@{ i } n )
                        ->
                        直積型@{ i } A ( 固定長列記型@{ i } n A )
                    )
                    _
        ...
        {
            refine ( fun x_2 : 道@{ i } 自然数@{ i } ( 後者関数@{ i } ( 長さを求める@{ i } A x_1_2 ) ) ( 後者関数@{ i } n ) => _ ) .
            refine ( 直積型を構築する@{ i } A ( 固定長列記型@{ i } n A ) _ _ ) .
            {
                exact x_1_1 .
            }
            {
                refine ( 固定長列記型.構築子@{ i } n A x_1_2 _ ) .
                refine
                    (
                        let
                            識別関数 : 自然数@{ i } -> 自然数@{ i }
...
End A_2024_09_15_0000 .

(** ** 異種列記型 *)

(** 異種列記型に関するモジュールを定義します。 *)

Module A_2024_09_16_0003 .
...
(** << A_2024_09_18_0004 >. を取り込みます。 *)

Import A_2024_09_18_0004 .

(** 異種列記型です。「異種」は "heterogenous" の訳語です。 *)

Inductive A_2024_09_16_0004@{ i i_次 | i < i_次 } ( A : 列記型@{ i_次 } Type@{ i } ) : Type@{ i_次 }
    :=
        A_2024_09_16_0005
            :
                forall x : 列記型@{ i_次 } A_2024_09_18_0005@{ i i_次 } ,
                道@{ i_次 }
                    ( 列記型@{ i_次 } Type@{ i } )
                    ( 写す@{ i_次 } Type@{ i } A_2024_09_18_0005@{ i i_次 } A_2024_09_18_0009@{ i i_次} x )
                    A
                ->
                A_2024_09_16_0004 A
.

End A_2024_09_16_0003 .

(** ** 固定長異種列記型 *)

(** 固定長異種列記型に関するモジュールを定義します。 *)

Module A_2024_09_18_0000 .
...
(** << A_2024_09_15_0000 >> を取り込みます。 *)

Import A_2024_09_15_0000 .

(** 固定長異種列記型です。 *)

Inductive A_2024_09_18_0001@{ i i_次 i_次_次 | i < i_次 , i_次 < i_次_次 }
    ( n : 自然数@{ i } )
    ( A : 固定長列記型@{ i_次 } n Type@{ i } )
    : Type@{ i_次 }
    :=
        A_2024_09_18_0002
            :
                forall x : 列記型@{ i_次 } A_2024_09_18_0005@{ i i_次 } ,
                forall y : 道@{ i_次 } 自然数@{ i_次 } ( 長さを求める@{ i_次 } A_2024_09_18_0005@{ i i_次 } x ) n ,
                A_2024_09_18_0001 n A
.

Definition 固定長異種列記型@{ i i_次 i_次_次 | i < i_次 , i_次 < i_次_次 }
    ( n : 自然数@{ i } )
    ( A : 固定長列記型@{ i_次 } n Type@{ i } )
    : Type@{ i_次 }
    := A_2024_09_18_0001@{ i i_次 i_次_次 } n A
.

End A_2024_09_18_0000 .

(** ** 可変長の引数を持つ関数 *)

(** 可変長の引数を持つ関数に関するモジュールを定義します。 *)

Module A_2024_09_13_0000 .
...
(** [n] 個の要素を持つ列記型を取る関数を [n] 個の引数を持つ関数に変換します。 *)

Definition A_2024_09_15_0005@{ i i_次 | i < i_次 }
    :
        forall n : 自然数@{ i } ,
        forall A : Type@{ i } ,
        forall B : Type@{ i } ,
...
Proof .
    ...
    refine
        (
            自然数.依存型の再帰@{ i }
                ...
                (
                    fun n_ : 自然数@{ i } =>
                    ( 固定長列記型@{ i } n_ A -> B ) -> A_2024_09_13_0001@{ i i_次 } n_ A B
                )
                _
                (
                    fun n_前 : 自然数@{ i } =>
                    fun a_前 : ( 固定長列記型@{ i } n_前 A -> B ) -> A_2024_09_13_0001@{ i i_次 } n_前 A B =>
                    _
                )
        )
    .
    {
        refine
            (
                鋳造@{ i i_次 }
                    ( ( 固定長列記型@{ i } ゼロ@{ i } A -> B ) -> A_2024_09_13_0001@{ i i_次 } ゼロ@{ i } A B )
                    ( ( 固定長列記型@{ i } ゼロ@{ i } A -> B ) -> B )
                    _
                    _
            )
        .
        {
            exact ( 恒等道@{ i_次 } Type@{ i } ( ( 固定長列記型@{ i } ゼロ@{ i } A -> B ) -> B ) ) .
        }
        {
            refine ( fun f : 固定長列記型@{ i } ゼロ@{ i } A -> B => _ ) .
            refine ( f _ ) .
            exact ( A_2024_09_15_0006@{ i } A ) .
        }
    }
    {
        refine
            (
                鋳造@{ i i_次 }
                    ( ( 固定長列記型@{ i } ( 後者関数@{ i } n_前 ) A -> B ) -> A_2024_09_13_0001@{ i i_次 } ( 後者関数@{ i } n_前 ) A B )
                    ( ( 固定長列記型@{ i } ( 後者関数@{ i } n_前 ) A -> B ) -> A -> A_2024_09_13_0001@{ i i_次 } n_前 A B )
                    _
                    _
            )
        .
        ...
        {
            refine ( fun f : 固定長列記型@{ i } ( 後者関数@{ i } n_前 ) A -> B => _ ) .
            refine ( fun x : A => _ ) .
            refine ( a_前 _ ) .
            refine ( fun y : 固定長列記型@{ i } n_前 A => _ ) .
            refine ( f _ ) .
            exact ( A_2024_09_15_0007@{ i i_次 } n_前 A x y ) .
        }
    }
Defined .
...
Definition A_2024_09_13_0003@{ i i_次 | i < i_次 }
    :
        forall n : 自然数@{ i } ,
        forall A : Type@{ i } ,
        forall B : Type@{ i } ,
...
Definition A_2024_09_13_0004@{ i i_次 | i < i_次 }
    :
        forall n : 自然数@{ i } ,
        forall A : Type@{ i } ,
        forall B : Type@{ i } ,
        forall C : Type@{ i } ,
        A_2024_09_13_0001@{ i i_次 } n B ( C -> A )
        ->
        A_2024_09_13_0001@{ i i_次 } n B C
        ->
        A_2024_09_13_0001@{ i i_次 } n B A
...
(** 等式推論に関するモジュールを定義します。「等式推論」は "equational reasoning" の訳語です。 *)

(** 等式推論とは「 a と b が等しい」を証明するために「 a と x が等しくて x と y が等しくて……」と変形していくことです。 *)

(** 等式推論は [結合] を使うことで可能ですが、入れ子の構造が深くなってしまうという欠点があります。 *)

(** そのため、等式推論のための関数を作ることにします。この関数は [等式推論] と名づけることにします。 [n] 個の途中式を経由する等式推論のための関数を [等式推論@{ i } A n] と書けるようにします。 *)

(** たとえば、 [等式推論@{ i } A ゼロ@{ i }] の型は [forall x : A , forall y : A , 道@{ i } A x y -> 道@{ i } A x y] です。たとえば、 [等式推論@{ i } A 一@{ i }] の型は [forall x : A , forall y : A , forall z : A , 道@{ i } A x y -> 道@{ i } A y z -> 道@{ i } A x z] です。たとえば、 [等式推論@{ i } A 二@{ i }] の型は [forall x : A , forall y : A , forall z : A , forall w : A , 道@{ i } A x y -> 道@{ i } A y z -> 道@{ i } A z w -> 道@{ i } A x w] です。 *)

(** [等式推論] を実装するためには、その型を特定する必要があります。 [等式推論@{ i } A n] の型は依存型となるため、 [等式推論@{ i } A n] の型を [等式推論の型@{ i } A n] で表すことにします。 *)

(** これを自然数についての再帰で表したいのですが、 [等式推論の型@{ i } A (後者関数@{ i } n )] は [等式推論の型@{ i } A n] で書くことができません。 *)

(** このため、 [等式推論の型@{ i } A n] を二個の部分に分けます。それは、 [A] の型を持つ値を全称量化する部分と、道を引数に取る部分です。後者を [T_0] とします。 [等式推論の型] は [T_0] に依存します。 *)

(** たとえば、 [等式推論の型@{ i } A ゼロ@{ i }] は [forall x : A , forall y : A , T_0 A ゼロ@{ i } x y] です。たとえば、 [等式推論の型@{ i } A 一@{ i }] は [forall x : A , forall y : A , forall z : A , T_0 A 一@{ i } x y z] です。たとえば、 [等式推論の型@{ i } A 二@{ i }] は [forall x : A , forall y : A , forall z : A , forall w : A , T_0 A 二@{ i } x y z w] です。 *)

(** このことからわかるように、 [T_0] の型もまた依存型です。 [T_0 A n] の型を [T_1 A n] とします。 *)

(** [T_1 A ゼロ@{ i }] は [自然数@{ i } -> 自然数@{ i } -> Type@{ i }] です。 [T_1 A 一@{ i }] は [自然数@{ i } -> 自然数@{ i } -> 自然数@{ i } -> Type@{ i }] です。 [T_1 A 二@{ i }] は [自然数@{ i } -> 自然数@{ i } -> 自然数@{ i } -> 自然数@{ i } -> Type@{ i }] です。 *)

(** [T_1 A ( 後者関数@{ i } n )] は [自然数@{ i } -> T_1 A n] となります。このことから、 [T_1] を定義することができます。 *)

(** [T_0] の定義を考えましょう。 [T_0 A ゼロ@{ i }] は [fun x : 自然数@{ i } => fun y : 自然数@{ i } => 道@{ i } A x y -> 道@{ i } A x y] です。 [T_0 A 一@{ i }] は [fun x : 自然数@{ i } => fun y : 自然数@{ i } => fun z : 自然数@{ i } => 道@{ i } A x y -> 道@{ i } A y z -> 道@{ i } A x z] です。 [T_0 A 二@{ i }] は [fun x : 自然数@{ i } => fun y : 自然数@{ i } => fun z : 自然数@{ i } => fun w : 自然数@{ i } => 道@{ i } A x y -> 道@{ i } A y z -> 道@{ i } A z w -> 道@{ i } A x w] です。 *)

(** ここから、道を取る部分は、単純に追加していく構造になっている一方で、返り値の型は変化していく構造になっているということがわかります。 *)

(** このため、前者と後者を分けて考え、後者の部分を [T_2] と名づけます。 [T_2 A n] の型は [T_0 A n] と同じく [T_1 A n] です。 [T_2 A ゼロ@{ i }] は [道@{ i } 自然数@{ i }] です。 [T_2 A ( 後者関数@{ i } n )] は [fun x : 自然数@{ i } => fun y : 自然数@{ i } => T_2 A n x] です。 *)

(** [T_0 A n] はそのまま再帰で定義することは難しそうです。このため、 [T_3 A n B] を挟むことにします。これは [T_3 A 二@{ i } ( T_2 A n x y z w ) x y z w] が [T_0 A 二@{ i } x y z w] と等しくなるような型です。 *)

(** [T_3 A ゼロ@{ i } B] は [fun x : 自然数@{ i } => fun y : 自然数@{ i } => 道@{ i } A x y -> B] です。 [T_3 A 一@{ i } B] は [fun x : 自然数@{ i } => fun y : 自然数@{ i } => fun z : 自然数@{ i } => 道@{ i } A x y -> 道@{ i } A y z -> B] です。 *)

(** [T_3 A ( 後者関数@{ i } n ) B] は [fun x : 自然数@{ i } => fun y : 自然数@{ i } => 可変長の合成@{ i } n ( fun C : Type@{ i } => 道@{ i } A x y -> C ) ( T_3 A n B )] です。 *)

(** ここまで考えると、可変長の引数を持つ関数を、独立した対象として取り扱う方が良さそうです。そうしましょう。 *)

Module A_2024_09_12_0000 .
...
(** << A_2024_09_18_0000 >> を取り込みます。 *)

Import A_2024_09_18_0000 .
...
Definition A_2024_09_17_0001@{ i i_次 i_次_次 | i < i_次 , i_次 < i_次_次 }
    :
        forall n : 自然数@{ i } ,
        forall A : Type@{ i } ,
        forall x : A ,
        ...
        forall z : A ,
        forall p : 固定長異種列記型@{ i i_次 i_次_次 } ( 後者関数@{ i } n ) ( A_2024_09_17_0000@{ i i_次 i_次_次 } n A x y z ) ,
...
Definition A_2024_09_16_0001@{ i i_次 i_次_次 | i < i_次 , i_次 < i_次_次 }
    : forall n : 自然数@{ i } , forall A : Type@{ i } , A -> 固定長列記型@{ i } n A -> A -> Type@{ i } -> Type@{ i }
.
Proof .
    refine ( fun n : 自然数@{ i } => _ ) .
    refine ( fun A : Type@{ i } => _ ) .
    refine
        (
            自然数.依存型の再帰@{ i_次 }
                ...
                (
                    fun n_ : 自然数@{ i } =>
                    A -> 固定長列記型@{ i } n_ A -> A -> Type@{ i } -> Type@{ i }
                )
                _
                (
                    fun n_前 : 自然数@{ i } =>
                    fun a_前 : A -> 固定長列記型@{ i } n_前 A -> A -> Type@{ i } -> Type@{ i } =>
                    _
                )
        )
    .
    ...
    }
    {
        ...
        refine
            (
                let
                    y_分解 : 直積型@{ i } A ( 固定長列記型@{ i } n_前 A ) := A_2024_09_16_0002@{ i i_次 } n_前 A y
                in
                    _
            )
        .
        exact
            (
                道@{ i } A x ( 直積型.一番目の区域の分解子 A ( 固定長列記型@{ i } n_前 A ) y_分解 )
                ->
                a_前
                    ( 直積型.一番目の区域の分解子 A ( 固定長列記型@{ i } n_前 A ) y_分解 )
                    ( 直積型.二番目の区域の分解子 ( 固定長列記型@{ i } n_前 A ) A y_分解 )
                    z
                    B
            )
        .
...
(** << A_2024_09_12_0000 >> を取り込みます。 *)

Import A_2024_09_12_0000 .
...
Definition A_2024_08_01_0000@{ i i_次 i_次_次 | i < i_次 , i_次 < i_次_次 }
    :
        forall x : 自然数@{ i } ,
        forall y : 自然数@{ i } ,
...
Definition A_2024_07_28_0006@{ i i_次 i_次_次 | i < i_次 , i_次 < i_次_次 }
    :
        forall x : 自然数@{ i } ,
        forall y : 自然数@{ i } ,
...
Definition A_2024_08_26_0000@{ i i_次 i_次_次 | i < i_次 , i_次 < i_次_次 }
    :
        forall m : 自然数@{ i } ,
        forall n : 自然数@{ i } ,
        forall o : 自然数@{ i } ,
        ...
        }
        {
            ...
            }
            {
                ...
                }
                {
                    ...
                    .
                    exact ( A_2024_07_28_0006@{ i i_次 i_次_次 } ( 足す@{ i } m_前 n_前 ) o_前 ) .
                }
                {
                    refine
                        (
                ...
                }
                {
                    ...
                    .
                    exact ( A_2024_08_01_0000@{ i i_次 i_次_次 } m_前 ( 足す@{ i } n_前 o_前 ) ) .
                }
                {
                    exact
                    (
...
Definition A_2024_08_26_0001@{ i i_次 i_次_次 | i < i_次 , i_次 < i_次_次 }
