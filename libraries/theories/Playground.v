...
Definition 計算する_最小_数_自然_ペアノ@{ i | } : 数_自然_ペアノ@{ i } -> 数_自然_ペアノ@{ i } -> 数_自然_ペアノ@{ i } := fix a ( x : 数_自然_ペアノ@{ i } ) ( y : 数_自然_ペアノ@{ i } ) { struct y } : 数_自然_ペアノ@{ i } := match x with 零_数_自然_ペアノ => 零_数_自然_ペアノ | 次ぐ_数_自然_ペアノ x_p => match y with 零_数_自然_ペアノ => 零_数_自然_ペアノ | 次ぐ_数_自然_ペアノ y_p => 次ぐ_数_自然_ペアノ (a x_p y_p) end end.

(** ペアノ式の自然数の最大値を定義します。 *)

Definition 計算する_最大_数_自然_ペアノ@{ i | } : 数_自然_ペアノ@{ i } -> 数_自然_ペアノ@{ i } -> 数_自然_ペアノ@{ i } := fix a ( x : 数_自然_ペアノ@{ i } ) ( y : 数_自然_ペアノ@{ i } ) { struct y } : 数_自然_ペアノ@{ i } := match x with 零_数_自然_ペアノ => y | 次ぐ_数_自然_ペアノ x_p => match y with 零_数_自然_ペアノ => x | 次ぐ_数_自然_ペアノ y_p => 次ぐ_数_自然_ペアノ (a x_p y_p) end end.
