...
(** [x] と [y] の後者を掛けた数は [x] と [x] と [y] を掛けた数と [y] を足した数に等しくなります。 *)
...
(** [x] と [y] を掛けた数は [y] と [x] を掛けた数に等しくなります。 *)
...
Proof .
    ...
    }
    {
        ...
        .
        {
            exact ( A_2024_09_25_0004@{ i } x y_前 ) .
        }
        {
            refine
                (
        ...
        }
        {
            ...
            exact ( A_2024_09_25_0005@{ i } y_前 x ) .
        }
    }
Defined .

(** [x] と [y] と [z] を足した数と掛けた数は [x] と [y] を掛けた数と [x] と [z] を掛けた数に等しくなります。 *)
...
(** [x] と [y] を足した数と [z] を掛けた数は [x] と [z] を掛けた数と [y] と [z] を掛けた数に等しくなります。 *)
