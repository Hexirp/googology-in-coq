            ...
            fix a ( x : 自然数@{ i } ) ( y : 自然数@{ i } ) { struct y } : 自然数@{ i }
                :=
                    ...
                    with
                        ...
                        |
                        A_2024_07_21_0033 y_前 => 掛ける@{ i } x ( a x y_前 )
                    end
        in
            a x y
.
            ...
            fix a ( x : 自然数@{ i } ) { struct x } : 自然数@{ i }
                :=
                    ...
                    with
                        ...
                        |
                        A_2024_07_21_0033 x_前 => 足す@{ i } x ( a x_前 )
                    end
        in
            a x
.
            ...
            fix a ( x : 自然数@{ i } ) { struct x } : 自然数@{ i }
                :=
                    ...
                    with
                        A_2024_07_21_0032 => A_2024_07_21_0034@{ i }
                        |
                        A_2024_07_21_0033 x_前 => 掛ける@{ i } x ( a x_前 )
                    end
        in
            a x
.
            ...
            fix a ( x : 自然数@{ i } ) ( y : 自然数@{ i } ) { struct x } : 自然数@{ i }
                :=
                    ...
                    with
                        ...
                        |
                        A_2024_07_21_0033 x_前 , A_2024_07_21_0033 y_前 => 足す@{ i } ( a x_前 y ) ( a x_前 y_前 )
                    end
        in
            a x y
.
            ...
            fix a ( x : 自然数@{ i } ) ( y : 自然数@{ i } ) ( z : 自然数@{ i } ) { struct x }
                ...
                :=
                    ...
                    with
                        A_2024_07_21_0032 => y
                        |
                        A_2024_07_21_0033 x_前 => a x_前 z ( 足す@{ i } y z )
                    end
        in
