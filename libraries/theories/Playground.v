...
Definition A_2024_07_21_0010@{ i }
        ...
        ( x : 直和型 B A )
    : A
    := match x with A_2024_07_21_0006 _ _ x_左 => 終了する@{ i } A ( 証拠 x_左 ) | A_2024_07_21_0007 _ _ x_右 => x_右 end
.
...
Definition A_2024_08_02_0000@{ i }
    ...
    :=
        ...
        with
            ...
            |
            A_2024_07_21_0007 _ _ x_右 => 終了する@{ i } A ( 否定型.分解子@{ i } B 証拠 x_右 )
        end
.
...
Definition A_2024_08_02_0001@{ i }
    ...
    :=
        match
            x
        with
            A_2024_07_21_0006 _ _ x_左 => 終了する@{ i } A ( 否定型.分解子@{ i } B 証拠 x_左 )
            |
