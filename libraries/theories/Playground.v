            ...
            負_構築子_整数 x_n
                =>
                    match
                        y
                    with
                        負_構築子_整数 y_n => 負_構築子_整数 ( 足す_正の自然数 x_n y_n )
                        |
...
Definition 正の自然数を掛ける_整数@{ i | } : 整数@{ i } -> 正の自然数@{ i } -> 整数@{ i }
    :=
        fix a ( x : 整数@{ i } ) ( y : 正の自然数@{ i } ) { struct y } : 整数@{ i }
            :=
                match
                    y
                with
                    一_構築子_正の自然数 => x
                    |
                    後者_構築子_正の自然数 y_p => 足す_整数 x ( a x y_p )
                end
.
...
Definition 掛ける_整数@{ i | } ( x : 整数@{ i } ) ( y : 整数@{ i } ) : 整数@{ i }
    :=
        match
            y
        with
            負_構築子_整数 y_n => 正の自然数を掛ける_整数 ( 符号を反転する_整数 x ) y_n
            |
            零_構築子_整数 => 零_整数
            |
            正_構築子_整数 y_p => 正の自然数を掛ける_整数 x y_p
        end
.
