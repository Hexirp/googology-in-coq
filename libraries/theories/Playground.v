...
(** 自然数を定義する。二進法の変種を使い、自然数 n を O ( log n ) で表現できるようにする。ここでの二進法の変種とは、 0, 1, 2, 11, 12, 21, 22, 111, 112, 121, 122, 211, 212, 221, 222, ... と表記する記数法である。 TypeTopology の Naturals.Binary を参考にしている。 TypeTopology の Naturals.Binary とは https://github.com/martinescardo/TypeTopology/blob/6fe4f2702026902ec5348dcd4cb02f89ef443ac7/source/Naturals/Binary.lagda のことである。 *)
...
Definition 後者を計算する_自然数@{ i | } : 自然数@{ i } -> 自然数@{ i }
    :=
        fix a ( x : 自然数@{ i } ) { struct x } : 自然数@{ i }
            :=
                match
                    x
                with
                    零_構築子_自然数 => 一_構築子_自然数 零_構築子_自然数
                    |
                    一_構築子_自然数 x_p => 二_構築子_自然数 x_p
                    |
                    二_構築子_自然数 x_p => 一_構築子_自然数 ( a x_p )
                end
.

Inductive 自然数の加算の繰り上がり@{ i | } : Type@{ i }
    :=
        零_構築子_自然数の加算の繰り上がり
        |
        一_構築子_自然数の加算の繰り上がり
...
Definition 繰り上がりも含めて足す_自然数@{ i | }
    : 自然数@{ i } -> 自然数@{ i } -> 自然数の加算の繰り上がり@{ i } -> 自然数@{ i }
    :=
                                ...
                                零_構築子_自然数
                                    =>
                                        match
                                            z
                                        with
                                            零_構築子_自然数の加算の繰り上がり => 零_構築子_自然数
                                            |
                                            一_構築子_自然数の加算の繰り上がり => 一_構築子_自然数 零_構築子_自然数
                                            |
                                            二_構築子_自然数の加算の繰り上がり => 二_構築子_自然数 零_構築子_自然数
                                        end
                                |
                                一_構築子_自然数 y_p
                                    =>
                                        match
                                            z
                                        with
                                            零_構築子_自然数の加算の繰り上がり => 一_構築子_自然数 y_p
                                            |
                                            一_構築子_自然数の加算の繰り上がり => 二_構築子_自然数 y_p
                                            |
                                            二_構築子_自然数の加算の繰り上がり
                                                => 一_構築子_自然数 ( 後者を計算する_自然数 y_p )
                                        end
                                |
                                二_構築子_自然数 y_p
                                    =>
                                        match
                                            z
                                        with
                                            零_構築子_自然数の加算の繰り上がり => 二_構築子_自然数 y_p
                                            |
                                            一_構築子_自然数の加算の繰り上がり
                                                => 一_構築子_自然数 ( 後者を計算する_自然数 y_p )
                                            |
                                            二_構築子_自然数の加算の繰り上がり
                                                => 二_構築子_自然数 ( 後者を計算する_自然数 y_p )
                                        end
                            end
                    |
                    一_構築子_自然数 x_p
                                ...
                                零_構築子_自然数
                                    =>
                                        match
                                            z
                                        with
                                            零_構築子_自然数の加算の繰り上がり => 一_構築子_自然数 x_p
                                            |
                                            一_構築子_自然数の加算の繰り上がり => 二_構築子_自然数 x_p
                                            |
                                            二_構築子_自然数の加算の繰り上がり
                                                => 一_構築子_自然数 ( 後者を計算する_自然数 x_p )
                                        end
                                |
                                一_構築子_自然数 y_p
                                    =>
                                        ...
                                        with
                                            零_構築子_自然数の加算の繰り上がり
                                                => 二_構築子_自然数 ( a x_p y_p 零_構築子_自然数の加算の繰り上がり )
                                            |
                                            一_構築子_自然数の加算の繰り上がり
                                                => 一_構築子_自然数 ( a x_p y_p 一_構築子_自然数の加算の繰り上がり )
                                            |
                                            二_構築子_自然数の加算の繰り上がり
                                                => 二_構築子_自然数 ( a x_p y_p 一_構築子_自然数の加算の繰り上がり )
                                        end
                                |
                                二_構築子_自然数 y_p
                                    =>
                                        ...
                                        with
                                            ...
                                            |
                                            二_構築子_自然数の加算の繰り上がり
                                                => 一_構築子_自然数 ( a x_p y_p 二_構築子_自然数の加算の繰り上がり )
                                        end
                            end
                    |
                    二_構築子_自然数 x_p
                                ...
                                零_構築子_自然数
                                    =>
                                        match
                                            z
                                        with
                                            零_構築子_自然数の加算の繰り上がり => 二_構築子_自然数 x_p
                                            |
                                            一_構築子_自然数の加算の繰り上がり
                                                => 一_構築子_自然数 ( 後者を計算する_自然数 x_p )
                                            |
                                            二_構築子_自然数の加算の繰り上がり
                                                => 二_構築子_自然数 ( 後者を計算する_自然数 x_p )
                                        end
                                |
                                一_構築子_自然数 y_p
                                    =>
                                ...
                                二_構築子_自然数 y_p
                                    =>
                                        ...
                                        with
                                            ...
                                            |
                                            二_構築子_自然数の加算の繰り上がり
                                                => 二_構築子_自然数 ( a x_p y_p 二_構築子_自然数の加算の繰り上がり )
                                        end
                            end
                end
.

Definition 足す_自然数@{ i | } ( x : 自然数@{ i } ) ( y : 自然数@{ i } ) : 自然数@{ i }
