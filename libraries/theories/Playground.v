...
Definition A_2024_08_26_0000@{ i | }
    :
        ...
        forall y : 自然数@{ i } ,
        forall z : 自然数@{ i } ,
        道@{ i } 自然数@{ i } ( 足す@{ i } ( 足す@{ i } x y ) z ) ( 足す@{ i } x ( 足す@{ i } y z ) )
.
Proof .
    refine ( fun x : 自然数@{ i } => _ ) .
    refine
        (
            自然数.依存型の再帰@{ i }
                ...
                (
                    ...
                    forall y : 自然数@{ i } ,
                    forall z : 自然数@{ i } ,
                    道@{ i } 自然数@{ i } ( 足す@{ i } ( 足す@{ i } x_ y ) z ) ( 足す@{ i } x_ ( 足す@{ i } y z ) )
                )
                _
                (
                    fun x_前 : 自然数@{ i } =>
                    fun
                        a_前
                            :
                                forall y : 自然数@{ i } ,
                                forall z : 自然数@{ i } ,
                                道@{ i } 自然数@{ i } ( 足す@{ i } ( 足す@{ i } x_前 y ) z ) ( 足す@{ i } x_前 ( 足す@{ i } y z ) )
                    =>
                        _
                )
        )
    .
    {
            ...
            (
                自然数.依存型の場合分け@{ i }
                    ...
                    (
                        fun y_ : 自然数@{ i } =>
                        forall z : 自然数@{ i } ,
                        道@{ i } 自然数@{ i } ( 足す@{ i } ( 足す@{ i } ゼロ@{ i } y_ ) z ) ( 足す@{ i } ゼロ@{ i } ( 足す@{ i } y_ z ) )
                    )
                    _
                    ( fun y_前 : 自然数@{ i } => _ )
            )
                ...
                (
                    自然数.依存型の場合分け@{ i }
                        ...
                        (
                            ...
                            道@{ i }
                                自然数@{ i }
                                ( 足す@{ i } ( 足す@{ i } ゼロ@{ i } ゼロ@{ i } ) z_ )
                                ( 足す@{ i } ゼロ@{ i } ( 足す@{ i } ゼロ@{ i } z_ ) )
                        )
                        _
                        ( fun z_前 : 自然数@{ i } => _ )
                )
        ...
        }
        {
                ...
                (
                    自然数.依存型の場合分け@{ i }
                        ...
                        (
                            ...
                            道@{ i }
                                自然数@{ i }
                                ( 足す@{ i } ( 足す@{ i } ゼロ@{ i } ( 後者関数@{ i } y_前 ) ) z_ )
                                ( 足す@{ i } ゼロ@{ i } ( 足す@{ i } ( 後者関数@{ i } y_前 ) z_ ) )
                        )
                        _
                        ( fun z_前 : 自然数@{ i } => _ )
                )
            ...
            {
                exact ( 恒等道@{ i } 自然数@{ i } ( 後者関数@{ i } ( 後者関数@{ i } ( 足す@{ i } y_前 z_前 ) ) ) ) .
            }
        }
    }
    {
            ...
            (
                自然数.依存型の場合分け@{ i }
                    ...
                    (
                        ...
                        道@{ i }
                            自然数@{ i }
                            ( 足す@{ i } ( 足す@{ i } ( 後者関数@{ i } x_前 ) y_ ) z )
                            ( 足す@{ i } ( 後者関数@{ i } x_前 ) ( 足す@{ i } y_ z ) )
                    )
                    _
                    ( fun y_前 : 自然数@{ i } => _ )
            )
        .
        {
                ...
                (
                    自然数.依存型の場合分け@{ i }
                        ...
                        (
                            ...
                            道@{ i }
                                自然数@{ i }
                                ( 足す@{ i } ( 足す@{ i } ( 後者関数@{ i } x_前 ) ゼロ@{ i } ) z_ )
                                ( 足す@{ i } ( 後者関数@{ i } x_前 ) ( 足す@{ i } ゼロ@{ i } z_ ) )
                        )
                        _
                        ( fun z_前 : 自然数@{ i } => _ )
                )
            ...
            {
                exact ( 恒等道@{ i } 自然数@{ i } ( 後者関数@{ i } ( 後者関数@{ i } ( 足す@{ i } x_前 z_前 ) ) ) ) .
            }
        }
        {
            refine ( fun z : 自然数@{ i } => _ ) .
                ...
                (
                    自然数.依存型の場合分け@{ i }
                        ...
                        (
                            ...
                            道@{ i }
                                自然数@{ i }
                                ( 足す@{ i } ( 足す@{ i } ( 後者関数@{ i } x_前 ) ( 後者関数@{ i } y_前 ) ) z_ )
                                ( 足す@{ i } ( 後者関数@{ i } x_前 ) ( 足す@{ i } ( 後者関数@{ i } y_前 ) z_ ) )
                        )
                        _
                        ( fun z_前 : 自然数@{ i } => _ )
                )
            .
            {
                exact ( 恒等道@{ i } 自然数@{ i } ( 後者関数@{ i } ( 後者関数@{ i } ( 足す@{ i } x_前 y_前 ) ) ) ) .
            }
            {
                refine
                    (
                        等式推論の七@{ i }
                            自然数@{ i }
                            ( 足す@{ i } ( 足す@{ i } ( 後者関数@{ i } x_前 ) ( 後者関数@{ i } y_前 ) ) ( 後者関数@{ i } z_前 ) )
                            ( 足す@{ i } ( 後者関数@{ i } ( 後者関数@{ i } ( 足す@{ i } x_前 y_前 ) ) ) ( 後者関数@{ i } z_前 ) )
                            ( 後者関数@{ i } ( 後者関数@{ i } ( 足す@{ i } ( 後者関数@{ i } ( 足す@{ i } x_前 y_前 ) ) z_前 ) ) )
                            ( 後者関数@{ i } ( 後者関数@{ i } ( 後者関数@{ i } ( 足す@{ i } ( 足す@{ i } x_前 y_前 ) z_前 ) ) ) )
                            ( 後者関数@{ i } ( 後者関数@{ i } ( 後者関数@{ i } ( 足す@{ i } x_前 ( 足す@{ i } y_前 z_前 ) ) ) ) )
                            ( 後者関数@{ i } ( 後者関数@{ i } ( 足す@{ i } x_前 ( 後者関数@{ i } ( 足す@{ i } y_前 z_前 ) ) ) ) )
                            ( 足す@{ i } ( 後者関数@{ i } x_前 ) ( 後者関数@{ i } ( 後者関数@{ i } ( 足す@{ i } y_前 z_前 ) ) ) )
                            ( 足す@{ i } ( 後者関数@{ i } x_前 ) ( 足す@{ i } ( 後者関数@{ i } y_前 ) ( 後者関数@{ i } z_前 ) ) )
                            _
                            _
                            _
                            _
                    ...
                    refine
                        (
                            適用@{ i }
                                ...
                                ( 足す@{ i } ( 後者関数@{ i } ( 足す@{ i } x_前 y_前 ) ) z_前 )
                                ( 後者関数@{ i } ( 足す@{ i } ( 足す@{ i } x_前 y_前 ) z_前 ) )
                                _
                        )
                    .
                    exact ( A_2024_07_28_0006@{ i } ( 足す@{ i } x_前 y_前 ) z_前 ) .
                }
                {
                    refine
                        (
                            適用@{ i }
                                ...
                                ( 足す@{ i } ( 足す@{ i } x_前 y_前 ) z_前 )
                                ( 足す@{ i } x_前 ( 足す@{ i } y_前 z_前 ) )
                                _
                        )
                    .
                    exact ( a_前 y_前 z_前 ) .
                }
                {
                    refine
                        (
                            適用@{ i }
                                ...
                                自然数@{ i }
                                ( fun w : 自然数@{ i } => 後者関数@{ i } ( 後者関数@{ i } w ) )
                                ( 後者関数@{ i } ( 足す@{ i } x_前 ( 足す@{ i } y_前 z_前 ) ) )
                                ( 足す@{ i } x_前 ( 後者関数@{ i } ( 足す@{ i } y_前 z_前 ) ) )
                                _
                        )
                    .
                    refine
                    ...
                    .
                    exact ( A_2024_08_01_0000@{ i } x_前 ( 足す@{ i } y_前 z_前 ) ) .
                }
                {
                    exact
                        (
...
Definition A_2024_08_26_0001@{ i | }
    : forall x : 自然数@{ i } , forall y : 自然数@{ i } , 道@{ i } 自然数@{ i } ( 足す@{ i } x y ) ( 足す@{ i } y x )
.
Proof .
    refine ( fun x : 自然数@{ i } => _ ) .
    refine
        (
            自然数.依存型の再帰@{ i }
                x
                ( fun x_ : 自然数@{ i } => forall y : 自然数@{ i } , 道@{ i } 自然数@{ i } ( 足す@{ i } x_ y ) ( 足す@{ i } y x_ ) )
                _
                (
                    fun x_前 : 自然数@{ i } =>
                    fun a_前 : forall y : 自然数@{ i } , 道@{ i } 自然数@{ i } ( 足す@{ i } x_前 y ) ( 足す@{ i } y x_前 ) =>
                    _
                )
        )
    .
    {
        ...
        refine
            (
                自然数.依存型の場合分け@{ i }
                    y
                    ( fun y_ : 自然数@{ i } => 道@{ i } 自然数@{ i } ( 足す@{ i } ゼロ@{ i } y_ ) ( 足す@{ i } y_ ゼロ@{ i } ) )
                    _
                    ( fun y_前 : 自然数@{ i } => _ )
            )
        .
        ...
        refine
            (
                自然数.依存型の場合分け@{ i }
                    ...
                    (
                        fun y_ : 自然数@{ i } =>
                        道@{ i } 自然数@{ i } ( 足す@{ i } ( 後者関数@{ i } x_前 ) y_ ) ( 足す@{ i } y_ ( 後者関数@{ i } x_前 ) )
                    )
                    _
                    ( fun y_前 : 自然数@{ i } => _ )
            )
        ...
        }
        {
            refine
                (
                    等式推論の三@{ i }
                        自然数@{ i }
                        ( 足す@{ i } ( 後者関数@{ i } x_前 ) ( 後者関数@{ i } y_前 ) )
                        ( 後者関数@{ i } ( 後者関数@{ i } ( 足す@{ i } x_前 y_前 ) ) )
                        ( 後者関数@{ i } ( 後者関数@{ i } ( 足す@{ i } y_前 x_前 ) ) )
                        ( 足す@{ i } ( 後者関数@{ i } y_前 ) ( 後者関数@{ i } x_前 ) )
                        _
                        _
                        _
                )
            ...
            {
                exact ( 恒等道@{ i } 自然数@{ i } ( 後者関数@{ i } ( 後者関数@{ i } ( 足す@{ i } y_前 x_前 ) ) ) ) .
            }
        }
    }
Defined .
...
Proof .
    ...
    }
    {
        ...
        .
        {
            exact ( 恒等道@{ i } 自然数@{ i } ( 足す@{ i } ゼロ@{ i } ( 掛ける@{ i } ゼロ@{ i } x_前 ) ) ) .
        }
        {
...
Proof .
    ...
    }
    {
        refine
            (
                等式推論の五@{ i }
                    ...
                    ( 足す@{ i } 一@{ i } ( 掛ける@{ i } 一@{ i } x_前 ) )
                    ( 足す@{ i } ( 後者関数@{ i } ゼロ@{ i } ) ( 掛ける@{ i } 一@{ i } x_前 ) )
                    ( 後者関数@{ i } ( 足す@{ i } ゼロ@{ i } ( 掛ける@{ i } 一@{ i } x_前 ) ) )
        ...
        .
        {
            exact ( 恒等道@{ i } 自然数@{ i } ( 足す@{ i } 一@{ i } ( 掛ける@{ i } 一@{ i } x_前 ) ) ) .
        }
        {
            exact ( 恒等道@{ i } 自然数@{ i } ( 足す@{ i } ( 後者関数@{ i } ゼロ@{ i } ) ( 掛ける@{ i } 一@{ i } x_前 ) ) ) .
        }
        {
...
Proof .
    ...
    {
        exact ( 恒等道@{ i } 自然数@{ i } ( 足す@{ i } x ( 掛ける@{ i } x ゼロ@{ i } ) ) ) .
    }
    {
        exact ( 恒等道@{ i } 自然数@{ i } ( 足す@{ i } x ゼロ@{ i } ) ) .
    }
    {
...
Definition A_2024_09_25_0004@{ i | }
    :
        forall x : 自然数@{ i } ,
        forall y : 自然数@{ i } ,
        道@{ i } 自然数@{ i } ( 掛ける@{ i } x ( 後者関数@{ i } y ) ) ( 足す@{ i } x ( 掛ける@{ i } x y ) )
.
Proof .
    refine ( fun x : 自然数@{ i } => _ ) .
    refine ( fun y : 自然数@{ i } => _ ) .
    exact ( 恒等道@{ i } 自然数@{ i } ( 足す@{ i } x ( 掛ける@{ i } x y ) ) ) .
Defined .
...
Definition A_2024_09_25_0005@{ i | }
    :
        forall x : 自然数@{ i } ,
        forall y : 自然数@{ i } ,
        道@{ i } 自然数@{ i } ( 掛ける@{ i } ( 後者関数@{ i } x ) y ) ( 足す@{ i } ( 掛ける@{ i } x y ) y )
.
Proof .
    refine ( fun x : 自然数@{ i } => _ ) .
    refine ( fun y : 自然数@{ i } => _ ) .
    refine
        (
            自然数.依存型の再帰@{ i }
                ...
                (
                    fun y_ : 自然数@{ i } =>
                    道@{ i } 自然数@{ i } ( 掛ける@{ i } ( 後者関数@{ i } x ) y_ ) ( 足す@{ i } ( 掛ける@{ i } x y_ ) y_ )
                )
                _
                (
                    fun y_前 : 自然数@{ i } =>
    ...
    }
    {
        refine
            (
                等式推論の六@{ i }
                    ...
                    ( 足す@{ i } ( 後者関数@{ i } x ) ( 掛ける@{ i } ( 後者関数@{ i } x ) y_前 ) )
                    ( 足す@{ i } ( 後者関数@{ i } x ) ( 足す@{ i } ( 掛ける@{ i } x y_前 ) y_前 ) )
                    ( 後者関数@{ i } ( 足す@{ i } x ( 足す@{ i } ( 掛ける@{ i } x y_前 ) y_前 ) ) )
                    ( 後者関数@{ i } ( 足す@{ i } ( 足す@{ i } x ( 掛ける@{ i } x y_前 ) ) y_前 ) )
                    ( 足す@{ i } ( 足す@{ i } x ( 掛ける@{ i } x y_前 ) ) ( 後者関数@{ i } y_前 ) )
                    ( 足す@{ i } ( 掛ける@{ i } x ( 後者関数@{ i } y_前 ) ) ( 後者関数@{ i } y_前 ) )
                    _
                    _
                    _
                    _
        ...
        .
        {
            exact ( 恒等道@{ i } 自然数@{ i } ( 足す@{ i } ( 後者関数@{ i } x ) ( 掛ける@{ i } ( 後者関数@{ i } x ) y_前 ) ) ) .
        }
        {
            refine
                (
        ...
        {
            exact ( A_2024_07_28_0006@{ i } x ( 足す@{ i } ( 掛ける@{ i } x y_前 ) y_前 ) ) .
        }
        {
            refine
                (
                    適用@{ i }
                        ...
                        ( 足す@{ i } x ( 足す@{ i } ( 掛ける@{ i } x y_前 ) y_前 ) )
                        ( 足す@{ i } ( 足す@{ i } x ( 掛ける@{ i } x y_前 ) ) y_前 )
                        _
                )
            .
            refine
        ...
        }
        {
            ...
            .
            exact ( A_2024_08_01_0000@{ i } ( 足す@{ i } x ( 掛ける@{ i } x y_前 ) ) y_前 ) .
        }
        {
            exact ( 恒等道@{ i } 自然数@{ i } ( 足す@{ i } ( 足す@{ i } x ( 掛ける@{ i } x y_前 ) ) ( 後者関数@{ i } y_前 ) ) ) .
        }
    }
Defined .
...
Proof .
    ...
    }
    {
        ...
        {
            refine ( 反転@{ i } 自然数@{ i } ( 足す@{ i } ( 掛ける@{ i } y_前 x ) x ) ( 掛ける@{ i } ( 後者関数@{ i } y_前 ) x ) _ ) .
...
Definition A_2024_09_30_0000@{ i | }
    :
        ...
        forall y : 自然数@{ i } ,
        forall z : 自然数@{ i } ,
        道@{ i } 自然数@{ i } ( 掛ける@{ i } x ( 足す@{ i } y z ) ) ( 足す@{ i } ( 掛ける@{ i } x y ) ( 掛ける@{ i } x z ) )
.
Proof .
    refine ( fun x : 自然数@{ i } => _ ) .
    refine ( fun y : 自然数@{ i } => _ ) .
    ...
    .
    {
        ...
        {
            refine ( 反転@{ i } 自然数@{ i } ( 掛ける@{ i } x y ) ( 足す@{ i } ( 掛ける@{ i } x y ) ゼロ@{ i } ) _ ) .
            exact ( A_2024_07_28_0005@{ i } ( 掛ける@{ i } x y ) ) .
        }
        {
            exact ( 恒等道@{ i } 自然数@{ i } ( 足す@{ i } ( 掛ける@{ i } x y ) ゼロ@{ i } ) ) .
        }
    }
    {
        refine
            (
                等式推論の七@{ i }
                    自然数@{ i }
                    ( 掛ける@{ i } x ( 足す@{ i } y ( 後者関数@{ i } z_前 ) ) )
                    ( 掛ける@{ i } x ( 後者関数@{ i } ( 足す@{ i } y z_前 ) ) )
                    ( 足す@{ i } x ( 掛ける@{ i } x ( 足す@{ i } y z_前 ) ) )
                    ( 足す@{ i } x ( 足す@{ i } ( 掛ける@{ i } x y ) ( 掛ける@{ i } x z_前 ) ) )
                    ( 足す@{ i } ( 足す@{ i } x ( 掛ける@{ i } x y ) ) ( 掛ける@{ i } x z_前 ) )
                    ( 足す@{ i } ( 足す@{ i } ( 掛ける@{ i } x y ) x ) ( 掛ける@{ i } x z_前 ) )
                    ( 足す@{ i } ( 掛ける@{ i } x y ) ( 足す@{ i } x ( 掛ける@{ i } x z_前 ) ) )
                    ( 足す@{ i } ( 掛ける@{ i } x y ) ( 掛ける@{ i } x ( 後者関数@{ i } z_前 ) ) )
                    _
                    _
                    _
                    _
        ...
        {
            exact ( 恒等道@{ i } 自然数@{ i } ( 足す@{ i } x ( 掛ける@{ i } x ( 足す@{ i } y z_前 ) ) ) ) .
        }
        {
            refine
                (
            ...
            refine
                (
                    適用@{ i }
                        自然数@{ i }
                        自然数@{ i }
                        ( fun w : 自然数@{ i } => 足す@{ i } w ( 掛ける@{ i } x z_前 ) )
                        ( 足す@{ i } x ( 掛ける@{ i } x y ) )
                        ( 足す@{ i } ( 掛ける@{ i } x y ) x )
                        _
                )
        ...
        {
            exact ( 恒等道@{ i } 自然数@{ i } ( 足す@{ i } ( 掛ける@{ i } x y ) ( 足す@{ i } x ( 掛ける@{ i } x z_前 ) ) ) ) .
        }
    }
Defined .
...
Definition A_2024_10_01_0000@{ i | }
    :
        ...
        forall y : 自然数@{ i } ,
        forall z : 自然数@{ i } ,
        道@{ i } 自然数@{ i } ( 掛ける@{ i } ( 足す@{ i } x y ) z ) ( 足す@{ i } ( 掛ける@{ i } x z ) ( 掛ける@{ i } y z ) )
.
Proof .
    refine ( fun x : 自然数@{ i } => _ ) .
    refine ( fun y : 自然数@{ i } => _ ) .
    ...
    }
    {
        refine
            (
                等式推論の八@{ i }
                    自然数@{ i }
                    ( 掛ける@{ i } ( 足す@{ i } x y ) ( 後者関数@{ i } z_前 ) )
                    ( 足す@{ i } ( 足す@{ i } x y ) ( 掛ける@{ i } ( 足す@{ i } x y ) z_前 ) )
                    ( 足す@{ i } ( 足す@{ i } x y ) ( 足す@{ i } ( 掛ける@{ i } x z_前 ) ( 掛ける@{ i } y z_前 ) ) )
                    ( 足す@{ i } x ( 足す@{ i } y ( 足す@{ i } ( 掛ける@{ i } x z_前 ) ( 掛ける@{ i } y z_前 ) ) ) )
                    ( 足す@{ i } x ( 足す@{ i } ( 足す@{ i } y ( 掛ける@{ i } x z_前 ) ) ( 掛ける@{ i } y z_前 ) ) )
                    ( 足す@{ i } x ( 足す@{ i } ( 足す@{ i } ( 掛ける@{ i } x z_前 ) y ) ( 掛ける@{ i } y z_前 ) ) )
                    ( 足す@{ i } x ( 足す@{ i } ( 掛ける@{ i } x z_前 ) ( 足す@{ i } y ( 掛ける@{ i } y z_前 ) ) ) )
                    ( 足す@{ i } ( 足す@{ i } x ( 掛ける@{ i } x z_前 ) ) ( 足す@{ i } y ( 掛ける@{ i } y z_前 ) ) )
                    ( 足す@{ i } ( 掛ける@{ i } x ( 後者関数@{ i } z_前 ) ) ( 掛ける@{ i } y ( 後者関数@{ i } z_前 ) ) )
                    _
                    _
                    _
                    _
        ...
        .
        {
            exact ( 恒等道@{ i } 自然数@{ i } ( 足す@{ i } ( 足す@{ i } x y ) ( 掛ける@{ i } ( 足す@{ i } x y ) z_前 ) ) ) .
        }
        {
            refine
                (
        ...
        {
            exact ( A_2024_08_26_0000@{ i } x y ( 足す@{ i } ( 掛ける@{ i } x z_前 ) ( 掛ける@{ i } y z_前 ) ) ) .
        }
        {
            refine
                (
                    適用@{ i }
                        ...
                        自然数@{ i }
                        ( fun w : 自然数@{ i } => 足す@{ i } x w )
                        ( 足す@{ i } y ( 足す@{ i } ( 掛ける@{ i } x z_前 ) ( 掛ける@{ i } y z_前 ) ) )
                        ( 足す@{ i } ( 足す@{ i } y ( 掛ける@{ i } x z_前 ) ) ( 掛ける@{ i } y z_前 ) )
                        _
                )
            .
            refine
            ...
            refine
                (
                    適用@{ i }
                        自然数@{ i }
                        自然数@{ i }
                        ( fun w : 自然数@{ i } => 足す@{ i } x ( 足す@{ i } w ( 掛ける@{ i } y z_前 ) ) )
                        ( 足す@{ i } y ( 掛ける@{ i } x z_前 ) )
                        ( 足す@{ i } ( 掛ける@{ i } x z_前 ) y )
                        _
                )
            ...
            refine
                (
                    適用@{ i }
                        ...
                        自然数@{ i }
                        ( fun w : 自然数@{ i } => 足す@{ i } x w )
                        ( 足す@{ i } ( 足す@{ i } ( 掛ける@{ i } x z_前 ) y ) ( 掛ける@{ i } y z_前 ) )
                        ( 足す@{ i } ( 掛ける@{ i } x z_前 ) ( 足す@{ i } y ( 掛ける@{ i } y z_前 ) ) )
                        _
                )
            .
        ...
        }
        {
            ...
            .
            exact ( A_2024_08_26_0000@{ i } x ( 掛ける@{ i } x z_前 ) ( 足す@{ i } y ( 掛ける@{ i } y z_前 ) ) ) .
        }
        {
            exact
                (
