...
Definition 場合分け@{ i | } ( 目標 : Type@{ i } ) ( 対象 : 空型@{ i } ) : 目標 := A_2024_07_21_0004@{ i } 目標 対象 .
...
Definition 依存型の場合分け@{ i | } ( 目標 : 空型@{ i } -> Type@{ i } ) ( 対象 : 空型@{ i } ) : 目標 対象
    := A_2024_08_26_0004@{ i } 目標 対象
.
...
Definition A_2024_08_27_0001@{ i | }
    : forall A : Type@{ i } , forall 目標 : Type@{ i } , ( ( A -> 空型@{ i } ) -> 目標 ) -> 否定型@{ i } A -> 目標
    :=
        fun A : Type@{ i } =>
        fun 目標 : Type@{ i } =>
        fun 処理 : ( A -> 空型@{ i } ) -> 目標 =>
...
Definition 場合分け@{ i | }
    ...
    ( 対象 : 否定型@{ i } A )
    : 目標
    := A_2024_08_27_0001@{ i } A 目標 処理 対象
.
...
Definition 依存型の場合分け@{ i | }
    ...
    ( 対象 : 否定型@{ i } A )
    : 目標 対象
    := A_2024_08_27_0002@{ i } A 目標 処理 対象
.
...
Definition A_2024_08_02_0000@{ i }
    ...
    :=
        ...
        with
            ...
            |
            A_2024_07_21_0007 _ _ x_右 => 空型.場合分け@{ i } A ( 否定型.分解子@{ i } B 証拠 x_右 )
        end
.
...
Definition A_2024_08_02_0001@{ i }
    ...
    :=
        match
            x
        with
            A_2024_07_21_0006 _ _ x_左 => 空型.場合分け@{ i } A ( 否定型.分解子@{ i } B 証拠 x_左 )
            |
...
Proof .
    ...
    .
    refine ( 否定型.分解子@{ i } ( A_2024_07_21_0005@{ i } ( A -> B ) ( B -> A ) ) x _ ) .
...
Proof .
    ...
    .
    refine ( 否定型.分解子@{ i } ( A_2024_07_21_0005@{ i } A ( 否定型@{ i } A ) ) x _ ) .
...
Proof .
    ...
    }
    {
        ...
        .
        refine ( 否定型.分解子@{ i } ( A_2024_07_21_0013@{ i } A B ) y _ ) .
...
Proof .
    ...
    .
    {
        ...
        .
        refine ( 否定型.分解子@{ i } ( 否定型@{ i } ( A_2024_07_21_0005@{ i } A B ) ) x _ ) .
    ...
    }
    {
        ...
        {
            exact ( 対偶を取る@{ i } A ( A_2024_07_21_0005@{ i } A B ) ( A_2024_07_21_0006@{ i } A B ) y ) .
        }
        {
            exact ( 対偶を取る@{ i } B ( A_2024_07_21_0005@{ i } A B ) ( A_2024_07_21_0007@{ i } A B ) y ) .
        }
    }
Defined .
