...
Inductive A_2024_09_18_0001@{ i i_次 i_次_次 | i < i_次 , i_次 < i_次_次 }
    : forall n : 自然数@{ i } , 固定長列記型@{ i_次 } n Type@{ i } -> Type@{ i_次 }
    :=
        A_2024_09_18_0002 : A_2024_09_18_0001 ゼロ@{ i } ( A_2024_09_15_0006@{ i_次 } Type@{ i } )
        |
        A_2024_09_18_0003
            :
                forall n : 自然数@{ i } ,
                forall A : Type@{ i } ,
                forall B : 固定長列記型@{ i_次 } n Type@{ i } ,
                A
                ->
                A_2024_09_18_0001 n B
                ->
                A_2024_09_18_0001 ( 後者関数@{ i } n ) ( A_2024_09_15_0007@{ i_次 i_次_次 } n Type@{ i } A B )
.
