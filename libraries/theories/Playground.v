...
Definition 計算する_列_数_フィボナッチ_数_自然_ペアノ_始まり_零@{ i | }
    ...
    :=
        ...
        in
            fun x : 数_自然_ペアノ_始まり_零@{ i }
            => a x 零_数_自然_ペアノ_始まり_零 一_数_自然_ペアノ_始まり_零
.
...
(** ペアノ式の自然数における加算の値について右の基点における値の補題を証明します。 *)

Definition 補題_値_基点_右_足す_数_自然_ペアノ@{ i | } ( m : 数_自然_ペアノ@{ i } )
    : 道 数_自然_ペアノ ( 足す_数_自然_ペアノ m 一_数_自然_ペアノ ) ( 次ぐ_数_自然_ペアノ m )
    := 道_恒等 _ _
.

(** ペアノ式の自然数における加算の値について左の基点における値の補題を証明します。 *)

Definition 補題_値_基点_左_足す_数_自然_ペアノ@{ i | } ( n : 数_自然_ペアノ@{ i } )
