...
Definition A_2024_09_25_0000@{ i | } : forall x : 自然数@{ i } , 道@{ i } 自然数@{ i } ( 掛ける@{ i } ゼロ@{ i } x ) ゼロ@{ i } .
Proof .
    refine ( fun x : 自然数@{ i } => _ ) .
    refine
        (
            自然数.依存型の再帰@{ i }
                x
                ( fun x_ : 自然数@{ i } => 道@{ i } 自然数@{ i } ( 掛ける@{ i } ゼロ@{ i } x_ ) ゼロ@{ i } )
                _
                ( fun x_前 : 自然数@{ i } => fun a_前 : 道@{ i } 自然数@{ i } ( 掛ける@{ i } ゼロ@{ i } x_前 ) ゼロ@{ i } => _ )
        )
    .
    {
        exact ( 恒等道@{ i } 自然数@{ i } ゼロ@{ i } ) .
    }
    {
        refine
            (
                等式推論の三@{ i }
                    自然数@{ i }
                    ( 掛ける@{ i } ゼロ@{ i } ( 後者関数@{ i } x_前 ) )
                    ( 和@{ i } ゼロ@{ i } ( 掛ける@{ i } ゼロ@{ i } x_前 ) )
                    ( 掛ける@{ i } ゼロ@{ i } x_前 )
                    ゼロ@{ i }
                    _
                    _
        ...
        .
        {
            exact ( 恒等道@{ i } 自然数@{ i } ( 和@{ i } ゼロ@{ i } ( 掛ける@{ i } ゼロ@{ i } x_前 ) ) ) .
        }
        {
            exact ( A_2024_07_28_0004@{ i } ( 掛ける@{ i } ゼロ@{ i } x_前 ) ) .
        }
        {
            exact a_前 .
        }
...
Definition A_2024_09_25_0001@{ i | } : forall x : 自然数@{ i } , 道@{ i } 自然数@{ i } ( 掛ける@{ i } x ゼロ@{ i } ) ゼロ@{ i } .
Proof .
    refine ( fun x : 自然数@{ i } => _ ) .
    exact ( 恒等道@{ i } 自然数@{ i } ゼロ@{ i } ) .
Defined .
...
Definition A_2024_09_25_0002@{ i | } : forall x : 自然数@{ i } , 道@{ i } 自然数@{ i } ( 掛ける@{ i } 一@{ i } x ) x .
Proof .
    refine ( fun x : 自然数@{ i } => _ ) .
    refine
        (
            自然数.依存型の再帰@{ i }
                x
                ( fun x_ : 自然数@{ i } => 道@{ i } 自然数@{ i } ( 掛ける@{ i } 一@{ i } x_ ) x_ )
                _
                ( fun x_前 : 自然数@{ i } => fun a_前 : 道@{ i } 自然数@{ i } ( 掛ける@{ i } 一@{ i } x_前 ) x_前 => _ )
        )
    .
    {
        exact ( 恒等道@{ i } 自然数@{ i } ゼロ@{ i } ) .
    }
    {
        refine
            (
                等式推論の五@{ i }
                    自然数@{ i }
                    ( 掛ける@{ i } 一@{ i } ( 後者関数@{ i } x_前 ) )
                    ( 和@{ i } 一@{ i } ( 掛ける@{ i } 一@{ i } x_前 ) )
                    ( 和@{ i } ( 後者関数@{ i } ゼロ@{ i } ) ( 掛ける@{ i } 一@{ i } x_前 ) )
                    ( 後者関数@{ i } ( 和@{ i } ゼロ@{ i } ( 掛ける@{ i } 一@{ i } x_前 ) ) )
                    ( 後者関数@{ i } ( 掛ける@{ i } 一@{ i } x_前 ) )
                    ( 後者関数@{ i } x_前 )
                    _
                    _
                    _
        ...
        .
        {
            exact ( 恒等道@{ i } 自然数@{ i } ( 和@{ i } 一@{ i } ( 掛ける@{ i } 一@{ i } x_前 ) ) ) .
        }
        {
            exact ( 恒等道@{ i } 自然数@{ i } ( 和@{ i } ( 後者関数@{ i } ゼロ@{ i } ) ( 掛ける@{ i } 一@{ i } x_前 ) ) ) .
        }
        {
            exact ( A_2024_07_28_0006@{ i } ゼロ@{ i } ( 掛ける@{ i } 一@{ i } x_前 ) ) .
        }
        {
            refine
                (
                    適用@{ i }
                        ...
                        ( 和@{ i } ゼロ@{ i } ( 掛ける@{ i } 一@{ i } x_前 ) )
                        ( 掛ける@{ i } 一@{ i } x_前 )
                        _
                )
            .
            exact ( A_2024_07_28_0004@{ i } ( 掛ける@{ i } 一@{ i } x_前 ) ) .
        }
        {
            refine
                (
...
Definition A_2024_09_25_0003@{ i | } : forall x : 自然数@{ i } , 道@{ i } 自然数@{ i } ( 掛ける@{ i } x 一@{ i } ) x .
Proof .
    refine ( fun x : 自然数@{ i } => _ ) .
    refine
        (
    ...
    .
    {
        exact ( 恒等道@{ i } 自然数@{ i } ( 掛ける@{ i } x ( 後者関数@{ i } ゼロ@{ i } ) ) ) .
    }
    {
        exact ( 恒等道@{ i } 自然数@{ i } ( 和@{ i } x ( 掛ける@{ i } x ゼロ@{ i } ) ) ) .
    }
    {
...
Definition A_2024_09_25_0004@{ i | }
    :
        forall x : 自然数@{ i } ,
        forall y : 自然数@{ i } ,
        道@{ i } 自然数@{ i } ( 掛ける@{ i } x ( 後者関数@{ i } y ) ) ( 和@{ i } x ( 掛ける@{ i } x y ) )
.
Proof .
    refine ( fun x : 自然数@{ i } => _ ) .
    refine ( fun y : 自然数@{ i } => _ ) .
    exact ( 恒等道@{ i } 自然数@{ i } ( 和@{ i } x ( 掛ける@{ i } x y ) ) ) .
Defined .
...
Definition A_2024_09_25_0005@{ i | }
    :
        forall x : 自然数@{ i } ,
        forall y : 自然数@{ i } ,
        道@{ i } 自然数@{ i } ( 掛ける@{ i } ( 後者関数@{ i } x ) y ) ( 和@{ i } ( 掛ける@{ i } x y ) y )
.
Proof .
    refine ( fun x : 自然数@{ i } => _ ) .
    refine ( fun y : 自然数@{ i } => _ ) .
    refine
        (
            自然数.依存型の再帰@{ i }
                ...
                (
                    fun y_ : 自然数@{ i } =>
                    道@{ i } 自然数@{ i } ( 掛ける@{ i } ( 後者関数@{ i } x ) y_ ) ( 和@{ i } ( 掛ける@{ i } x y_ ) y_ )
                )
                _
                (
                    fun y_前 : 自然数@{ i } =>
    ...
    }
    {
        refine
            (
                等式推論の六@{ i }
                    自然数@{ i }
                    ( 掛ける@{ i } ( 後者関数@{ i } x ) ( 後者関数@{ i } y_前 ) )
                    ( 和@{ i } ( 後者関数@{ i } x ) ( 掛ける@{ i } ( 後者関数@{ i } x ) y_前 ) )
                    ( 和@{ i } ( 後者関数@{ i } x ) ( 和@{ i } ( 掛ける@{ i } x y_前 ) y_前 ) )
                    ( 後者関数@{ i } ( 和@{ i } x ( 和@{ i } ( 掛ける@{ i } x y_前 ) y_前 ) ) )
                    ( 後者関数@{ i } ( 和@{ i } ( 和@{ i } x ( 掛ける@{ i } x y_前 ) ) y_前 ) )
                    ( 和@{ i } ( 和@{ i } x ( 掛ける@{ i } x y_前 ) ) ( 後者関数@{ i } y_前 ) )
                    ( 和@{ i } ( 掛ける@{ i } x ( 後者関数@{ i } y_前 ) ) ( 後者関数@{ i } y_前 ) )
                    _
                    _
                    _
                    _
        ...
        .
        {
            exact ( 恒等道@{ i } 自然数@{ i } ( 和@{ i } ( 後者関数@{ i } x ) ( 掛ける@{ i } ( 後者関数@{ i } x ) y_前 ) ) ) .
        }
        {
            refine
                (
        ...
        {
            exact ( A_2024_07_28_0006@{ i } x ( 和@{ i } ( 掛ける@{ i } x y_前 ) y_前 ) ) .
        }
        {
            refine
                (
                    適用@{ i }
                        ...
                        ( 和@{ i } x ( 和@{ i } ( 掛ける@{ i } x y_前 ) y_前 ) )
                        ( 和@{ i } ( 和@{ i } x ( 掛ける@{ i } x y_前 ) ) y_前 )
                        _
                )
            .
            refine
            ...
            .
            exact ( A_2024_08_26_0000@{ i } x ( 掛ける@{ i } x y_前 ) y_前 ) .
        }
        {
            refine
                (
            ...
            .
            exact ( A_2024_08_01_0000@{ i } ( 和@{ i } x ( 掛ける@{ i } x y_前 ) ) y_前 ) .
        }
        {
            exact ( 恒等道@{ i } 自然数@{ i } ( 和@{ i } ( 和@{ i } x ( 掛ける@{ i } x y_前 ) ) ( 後者関数@{ i } y_前 ) ) ) .
        }
    }
Defined .
...
Definition A_2024_09_26_0000@{ i | }
    : forall x : 自然数@{ i } , forall y : 自然数@{ i } , 道@{ i } 自然数@{ i } ( 掛ける@{ i } x y ) ( 掛ける@{ i } y x )
.
Proof .
    refine ( fun x : 自然数@{ i } => _ ) .
    refine ( fun y : 自然数@{ i } => _ ) .
    refine
        (
            自然数.依存型の再帰@{ i }
                y
                ( fun y_ : 自然数@{ i } => 道@{ i } 自然数@{ i } ( 掛ける@{ i } x y_ ) ( 掛ける@{ i } y_ x ) )
                _
                ( fun y_前 : 自然数@{ i } => fun a_前 : 道@{ i } 自然数@{ i } ( 掛ける@{ i } x y_前 ) ( 掛ける@{ i } y_前 x ) => _ )
        )
    .
    {
        refine
        ...
        {
            refine ( 反転@{ i } 自然数@{ i } ゼロ@{ i } ( 掛ける@{ i } ゼロ@{ i } x ) _ ) .
    ...
    }
    {
        ...
        {
            exact ( A_2024_08_26_0001@{ i } x ( 掛ける@{ i } y_前 x ) ) .
        }
        {
            refine ( 反転@{ i } 自然数@{ i } ( 和@{ i } ( 掛ける@{ i } y_前 x ) x ) ( 掛ける@{ i } ( 後者関数@{ i } y_前 ) x ) _ ) .
...
Definition A_2024_09_30_0000@{ i | }
    :
        ...
        forall y : 自然数@{ i } ,
        forall z : 自然数@{ i } ,
        道@{ i } 自然数@{ i } ( 掛ける@{ i } x ( 和@{ i } y z ) ) ( 和@{ i } ( 掛ける@{ i } x y ) ( 掛ける@{ i } x z ) )
.
Proof .
    refine ( fun x : 自然数@{ i } => _ ) .
    refine ( fun y : 自然数@{ i } => _ ) .
    ...
    .
    {
        ...
        {
            refine ( 反転@{ i } 自然数@{ i } ( 掛ける@{ i } x y ) ( 和@{ i } ( 掛ける@{ i } x y ) ゼロ@{ i } ) _ ) .
            exact ( A_2024_07_28_0005@{ i } ( 掛ける@{ i } x y ) ) .
        }
        {
            exact ( 恒等道@{ i } 自然数@{ i } ( 和@{ i } ( 掛ける@{ i } x y ) ゼロ@{ i } ) ) .
        }
    }
    {
        refine
            (
                等式推論の七@{ i }
                    自然数@{ i }
                    ( 掛ける@{ i } x ( 和@{ i } y ( 後者関数@{ i } z_前 ) ) )
                    ( 掛ける@{ i } x ( 後者関数@{ i } ( 和@{ i } y z_前 ) ) )
                    ( 和@{ i } x ( 掛ける@{ i } x ( 和@{ i } y z_前 ) ) )
                    ( 和@{ i } x ( 和@{ i } ( 掛ける@{ i } x y ) ( 掛ける@{ i } x z_前 ) ) )
                    ( 和@{ i } ( 和@{ i } x ( 掛ける@{ i } x y ) ) ( 掛ける@{ i } x z_前 ) )
                    ( 和@{ i } ( 和@{ i } ( 掛ける@{ i } x y ) x ) ( 掛ける@{ i } x z_前 ) )
                    ( 和@{ i } ( 掛ける@{ i } x y ) ( 和@{ i } x ( 掛ける@{ i } x z_前 ) ) )
                    ( 和@{ i } ( 掛ける@{ i } x y ) ( 掛ける@{ i } x ( 後者関数@{ i } z_前 ) ) )
                    _
                    _
                    _
                    _
        ...
        {
            exact ( 恒等道@{ i } 自然数@{ i } ( 和@{ i } x ( 掛ける@{ i } x ( 和@{ i } y z_前 ) ) ) ) .
        }
        {
            refine
                (
        ...
        }
        {
            ...
            .
            exact ( A_2024_08_26_0000@{ i } x ( 掛ける@{ i } x y ) ( 掛ける@{ i } x z_前 ) ) .
        }
        {
            refine
                (
                    適用@{ i }
                        自然数@{ i }
                        自然数@{ i }
                        ( fun w : 自然数@{ i } => 和@{ i } w ( 掛ける@{ i } x z_前 ) )
                        ( 和@{ i } x ( 掛ける@{ i } x y ) )
                        ( 和@{ i } ( 掛ける@{ i } x y ) x )
                        _
                )
            .
            exact ( A_2024_08_26_0001@{ i } x ( 掛ける@{ i } x y ) ) .
        }
        {
            exact ( A_2024_08_26_0000@{ i } ( 掛ける@{ i } x y ) x ( 掛ける@{ i } x z_前 ) ) .
        }
        {
            exact ( 恒等道@{ i } 自然数@{ i } ( 和@{ i } ( 掛ける@{ i } x y ) ( 和@{ i } x ( 掛ける@{ i } x z_前 ) ) ) ) .
        }
    }
Defined .
...
Definition A_2024_10_01_0000@{ i | }
    :
        ...
        forall y : 自然数@{ i } ,
        forall z : 自然数@{ i } ,
        道@{ i } 自然数@{ i } ( 掛ける@{ i } ( 和@{ i } x y ) z ) ( 和@{ i } ( 掛ける@{ i } x z ) ( 掛ける@{ i } y z ) )
.
Proof .
    refine ( fun x : 自然数@{ i } => _ ) .
    refine ( fun y : 自然数@{ i } => _ ) .
    ...
    }
    {
        refine
            (
                等式推論の八@{ i }
                    自然数@{ i }
                    ( 掛ける@{ i } ( 和@{ i } x y ) ( 後者関数@{ i } z_前 ) )
                    ( 和@{ i } ( 和@{ i } x y ) ( 掛ける@{ i } ( 和@{ i } x y ) z_前 ) )
                    ( 和@{ i } ( 和@{ i } x y ) ( 和@{ i } ( 掛ける@{ i } x z_前 ) ( 掛ける@{ i } y z_前 ) ) )
                    ( 和@{ i } x ( 和@{ i } y ( 和@{ i } ( 掛ける@{ i } x z_前 ) ( 掛ける@{ i } y z_前 ) ) ) )
                    ( 和@{ i } x ( 和@{ i } ( 和@{ i } y ( 掛ける@{ i } x z_前 ) ) ( 掛ける@{ i } y z_前 ) ) )
                    ( 和@{ i } x ( 和@{ i } ( 和@{ i } ( 掛ける@{ i } x z_前 ) y ) ( 掛ける@{ i } y z_前 ) ) )
                    ( 和@{ i } x ( 和@{ i } ( 掛ける@{ i } x z_前 ) ( 和@{ i } y ( 掛ける@{ i } y z_前 ) ) ) )
                    ( 和@{ i } ( 和@{ i } x ( 掛ける@{ i } x z_前 ) ) ( 和@{ i } y ( 掛ける@{ i } y z_前 ) ) )
                    ( 和@{ i } ( 掛ける@{ i } x ( 後者関数@{ i } z_前 ) ) ( 掛ける@{ i } y ( 後者関数@{ i } z_前 ) ) )
                    _
                    _
                    _
                    _
        ...
        .
        {
            exact ( 恒等道@{ i } 自然数@{ i } ( 和@{ i } ( 和@{ i } x y ) ( 掛ける@{ i } ( 和@{ i } x y ) z_前 ) ) ) .
        }
        {
            refine
                (
        ...
        {
            exact ( A_2024_08_26_0000@{ i } x y ( 和@{ i } ( 掛ける@{ i } x z_前 ) ( 掛ける@{ i } y z_前 ) ) ) .
        }
        {
            refine
                (
                    適用@{ i }
                        ...
                        自然数@{ i }
                        ( fun w : 自然数@{ i } => 和@{ i } x w )
                        ( 和@{ i } y ( 和@{ i } ( 掛ける@{ i } x z_前 ) ( 掛ける@{ i } y z_前 ) ) )
                        ( 和@{ i } ( 和@{ i } y ( 掛ける@{ i } x z_前 ) ) ( 掛ける@{ i } y z_前 ) )
                        _
                )
            .
            refine
            ...
            .
            exact ( A_2024_08_26_0000@{ i } y ( 掛ける@{ i } x z_前 ) ( 掛ける@{ i } y z_前 ) ) .
        }
        {
            refine
                (
                    適用@{ i }
                        自然数@{ i }
                        自然数@{ i }
                        ( fun w : 自然数@{ i } => 和@{ i } x ( 和@{ i } w ( 掛ける@{ i } y z_前 ) ) )
                        ( 和@{ i } y ( 掛ける@{ i } x z_前 ) )
                        ( 和@{ i } ( 掛ける@{ i } x z_前 ) y )
                        _
                )
            .
            exact ( A_2024_08_26_0001@{ i } y ( 掛ける@{ i } x z_前 ) ) .
        }
        {
            refine
                (
                    適用@{ i }
                        ...
                        自然数@{ i }
                        ( fun w : 自然数@{ i } => 和@{ i } x w )
                        ( 和@{ i } ( 和@{ i } ( 掛ける@{ i } x z_前 ) y ) ( 掛ける@{ i } y z_前 ) )
                        ( 和@{ i } ( 掛ける@{ i } x z_前 ) ( 和@{ i } y ( 掛ける@{ i } y z_前 ) ) )
                        _
                )
            .
            exact ( A_2024_08_26_0000@{ i } ( 掛ける@{ i } x z_前 ) y ( 掛ける@{ i } y z_前 ) ) .
        }
        {
            refine
                (
            ...
            .
            exact ( A_2024_08_26_0000@{ i } x ( 掛ける@{ i } x z_前 ) ( 和@{ i } y ( 掛ける@{ i } y z_前 ) ) ) .
        }
        {
            exact
                (
