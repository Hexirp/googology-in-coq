...
Definition A_2024_08_28_0011@{ i | }
    :
        ...
        ( forall 対象_1 : A , forall 対象_2 : B , 目標 ( A_2024_08_28_0009@{ i } A B 対象_1 対象_2 ) )
        ->
        目標 対象
    :=
        fun A : Type@{ i } =>
        ...
        fun 処理 : forall 対象_1 : A , forall 対象_2 : B , 目標 ( A_2024_08_28_0009@{ i } A B 対象_1 対象_2 ) =>
        直積型.余場合分けの整合性@{ i }
            A
            B
            ( 直積型@{ i } A B )
...
Definition A_2024_07_21_0017@{ i | }
    ...
    :=
        ...
        fun x_1 : B =>
        fun x_2 : C =>
        f ( A_2024_08_28_0009@{ i } B C x_1 x_2 )
.
...
Definition A_2024_07_21_0028@{ i | } : ブール型@{ i } -> ブール型@{ i }
    := fun x : ブール型@{ i } => ブール型.場合分け x ブール型@{ i } ブール型.真の場合の構築子@{ i } ブール型.偽の場合の構築子@{ i }
.
...
Definition ゼロから始まる自然数@{ i | } : Type@{ i } := A_2024_07_21_0031@{ i } .

Module A_2024_07_21_0031 .

Definition ゼロの場合の構築子@{ i | } : ゼロから始まる自然数@{ i } := A_2024_07_21_0032@{ i } .

Definition 後者の場合の構築子@{ i | } ( x : ゼロから始まる自然数@{ i } ) : ゼロから始まる自然数@{ i } := A_2024_07_21_0033@{ i } x .

End A_2024_07_21_0031 .

Module ゼロから始まる自然数 := A_2024_07_21_0031 .
...
Import A_2024_08_30_0003 .

Import A_2024_08_30_0006 .

(** 一です。 *)

Definition A_2024_07_21_0034@{ i | } : ゼロから始まる自然数@{ i } := A_2024_07_21_0033@{ i } A_2024_07_21_0032@{ i } .

(** 二です。 *)

Definition A_2024_07_21_0035@{ i | } : ゼロから始まる自然数@{ i } := A_2024_07_21_0033@{ i } A_2024_07_21_0034@{ i } .

(** 三です。 *)

Definition A_2024_07_21_0036@{ i | } : ゼロから始まる自然数@{ i } := A_2024_07_21_0033@{ i } A_2024_07_21_0035@{ i } .

(** 四です。 *)

Definition A_2024_07_21_0037@{ i | } : ゼロから始まる自然数@{ i } := A_2024_07_21_0033@{ i } A_2024_07_21_0036@{ i } .

(** 五です。 *)

Definition A_2024_07_21_0038@{ i | } : ゼロから始まる自然数@{ i } := A_2024_07_21_0033@{ i } A_2024_07_21_0037@{ i } .

(** 六です。 *)

Definition A_2024_07_21_0039@{ i | } : ゼロから始まる自然数@{ i } := A_2024_07_21_0033@{ i } A_2024_07_21_0038@{ i } .

(** 七です。 *)

Definition A_2024_07_21_0040@{ i | } : ゼロから始まる自然数@{ i } := A_2024_07_21_0033@{ i } A_2024_07_21_0039@{ i } .

(** 八です。 *)

Definition A_2024_07_21_0041@{ i | } : ゼロから始まる自然数@{ i } := A_2024_07_21_0033@{ i } A_2024_07_21_0040@{ i } .

(** 九です。 *)

Definition A_2024_07_21_0042@{ i | } : ゼロから始まる自然数@{ i } := A_2024_07_21_0033@{ i } A_2024_07_21_0041@{ i } .

(** 十です。 *)

Definition A_2024_07_21_0043@{ i | } : ゼロから始まる自然数@{ i } := A_2024_07_21_0033@{ i } A_2024_07_21_0042@{ i } .

(** 二を足します。 *)

Definition A_2024_07_21_0044@{ i | } ( x : ゼロから始まる自然数@{ i } ) : ゼロから始まる自然数@{ i }
    := A_2024_07_21_0033@{ i } ( A_2024_07_21_0033@{ i } x )
.

(** 三を足します。 *)

Definition A_2024_07_21_0045@{ i | } ( x : ゼロから始まる自然数@{ i } ) : ゼロから始まる自然数@{ i }
    := A_2024_07_21_0033@{ i } ( A_2024_07_21_0044@{ i } x )
.

(** 四を足します。 *)

Definition A_2024_07_21_0046@{ i | } ( x : ゼロから始まる自然数@{ i } ) : ゼロから始まる自然数@{ i }
    := A_2024_07_21_0033@{ i } ( A_2024_07_21_0045@{ i } x )
.

(** 五を足します。 *)

Definition A_2024_07_21_0047@{ i | } ( x : ゼロから始まる自然数@{ i } ) : ゼロから始まる自然数@{ i }
    := A_2024_07_21_0033@{ i } ( A_2024_07_21_0046@{ i } x )
.

(** 六を足します。 *)

Definition A_2024_07_21_0048@{ i | } ( x : ゼロから始まる自然数@{ i } ) : ゼロから始まる自然数@{ i }
    := A_2024_07_21_0033@{ i } ( A_2024_07_21_0047@{ i } x )
.

(** 七を足します。 *)

Definition A_2024_07_21_0049@{ i | } ( x : ゼロから始まる自然数@{ i } ) : ゼロから始まる自然数@{ i }
    := A_2024_07_21_0033@{ i } ( A_2024_07_21_0048@{ i } x )
.

(** 八を足します。 *)

Definition A_2024_07_21_0050@{ i | } ( x : ゼロから始まる自然数@{ i } ) : ゼロから始まる自然数@{ i }
    := A_2024_07_21_0033@{ i } ( A_2024_07_21_0049@{ i } x )
.

(** 九を足します。 *)

Definition A_2024_07_21_0051@{ i | } ( x : ゼロから始まる自然数@{ i } ) : ゼロから始まる自然数@{ i }
    := A_2024_07_21_0033@{ i } ( A_2024_07_21_0050@{ i } x )
.

(** 十を足します。 *)

Definition A_2024_07_21_0052@{ i | } ( x : ゼロから始まる自然数@{ i } ) : ゼロから始まる自然数@{ i }
    := A_2024_07_21_0033@{ i } ( A_2024_07_21_0051@{ i } x )
.

(** 足します。 *)

Definition A_2024_07_21_0053@{ i | } ( x : ゼロから始まる自然数@{ i } ) ( y : ゼロから始まる自然数@{ i } ) : ゼロから始まる自然数@{ i }
    :=
        let
            fix a ( x : ゼロから始まる自然数@{ i } ) ( y : ゼロから始まる自然数@{ i } ) { struct x } : ゼロから始まる自然数@{ i }
                :=
                    match
                        x , y
                    with
...
Definition A_2024_07_21_0054@{ i | } ( x : ゼロから始まる自然数@{ i } ) ( y : ゼロから始まる自然数@{ i } ) : ゼロから始まる自然数@{ i }
    :=
        let
            fix a ( x : ゼロから始まる自然数@{ i } ) ( y : ゼロから始まる自然数@{ i } ) { struct y } : ゼロから始まる自然数@{ i }
                :=
                    match
                        y
                    with
...
Definition A_2024_07_21_0055@{ i | } ( x : ゼロから始まる自然数@{ i } ) ( y : ゼロから始まる自然数@{ i } ) : ゼロから始まる自然数@{ i }
    :=
        let
            fix a ( x : ゼロから始まる自然数@{ i } ) ( y : ゼロから始まる自然数@{ i } ) { struct y } : ゼロから始まる自然数@{ i }
                :=
...
Definition A_2024_07_21_0060@{ i | } ( x : ゼロから始まる自然数@{ i } ) ( y : ゼロから始まる自然数@{ i } ) : ゼロから始まる自然数@{ i }
    :=
        let
            fix a ( x : ゼロから始まる自然数@{ i } ) ( y : ゼロから始まる自然数@{ i } ) { struct y } : ゼロから始まる自然数@{ i }
                :=
...
Definition A_2024_07_21_0056@{ i | } ( x : ゼロから始まる自然数@{ i } ) ( y : ゼロから始まる自然数@{ i } ) : ゼロから始まる自然数@{ i }
    :=
        let
            fix a ( x : ゼロから始まる自然数@{ i } ) ( y : ゼロから始まる自然数@{ i } ) { struct x } : ゼロから始まる自然数@{ i }
                :=
...
Definition A_2024_07_21_0057@{ i | } ( x : ゼロから始まる自然数@{ i } ) ( y : ゼロから始まる自然数@{ i } ) : ゼロから始まる自然数@{ i }
    :=
        let
            fix a ( x : ゼロから始まる自然数@{ i } ) ( y : ゼロから始まる自然数@{ i } ) { struct x } : ゼロから始まる自然数@{ i }
                :=
...
Definition A_2024_07_21_0058@{ i | } ( x : ゼロから始まる自然数@{ i } ) : ゼロから始まる自然数@{ i }
    :=
        let
            fix a ( x : ゼロから始まる自然数@{ i } ) { struct x } : ゼロから始まる自然数@{ i }
                :=
                    match
                        x
                    with
...
Definition A_2024_07_21_0059@{ i | } ( x : ゼロから始まる自然数@{ i } ) : ゼロから始まる自然数@{ i }
    :=
        let
            fix a ( x : ゼロから始まる自然数@{ i } ) { struct x } : ゼロから始まる自然数@{ i }
                :=
...
Definition A_2024_07_21_0061@{ i | } ( x : ゼロから始まる自然数@{ i } ) ( y : ゼロから始まる自然数@{ i } ) : ゼロから始まる自然数@{ i }
    :=
        let
            fix a ( x : ゼロから始まる自然数@{ i } ) ( y : ゼロから始まる自然数@{ i } ) { struct x } : ゼロから始まる自然数@{ i }
                :=
...
Definition A_2024_07_21_0062@{ i | } ( x : ゼロから始まる自然数@{ i } ) : ゼロから始まる自然数@{ i }
    :=
        let
            fix a ( x : ゼロから始まる自然数@{ i } ) ( y : ゼロから始まる自然数@{ i } ) ( z : ゼロから始まる自然数@{ i } ) { struct x }
                : ゼロから始まる自然数@{ i }
                :=
                    match
                        x
...
Definition A_2024_08_02_0003@{ i | } ( x : ゼロから始まる自然数@{ i } ) : ゼロから始まる自然数@{ i }
    :=
        let
            fix a ( x : ゼロから始まる自然数@{ i } ) ( y : ゼロから始まる自然数@{ i } ) ( z : ゼロから始まる自然数@{ i } ) { struct x }
                : ゼロから始まる自然数@{ i }
...
Definition A_2024_08_16_0005@{ i | } ( A : Type@{ i } ) ( x : A_2024_08_16_0000@{ i } A ) : ゼロから始まる自然数@{ i }
    :=
        let
            fix a ( x_ : A_2024_08_16_0000@{ i } A ) { struct x_ } : ゼロから始まる自然数@{ i }
                :=
                    match
                        x_
                    with
...
Definition A_2024_08_16_0006@{ i | } ( x : A_2024_08_16_0000@{ i } ゼロから始まる自然数@{ i } ) : ゼロから始まる自然数@{ i }
    :=
        let
            fix a ( x_ : A_2024_08_16_0000@{ i } ゼロから始まる自然数@{ i } ) { struct x_ } : ゼロから始まる自然数@{ i }
                :=
                    match
                        x_
                    with
...
Definition A_2024_08_16_0007@{ i | } ( x : A_2024_08_16_0000@{ i } ゼロから始まる自然数@{ i } ) : ゼロから始まる自然数@{ i }
    :=
        let
            fix a ( x_ : A_2024_08_16_0000@{ i } ゼロから始まる自然数@{ i } ) { struct x_ } : ゼロから始まる自然数@{ i }
                :=
...
Definition A_2024_08_02_0008@{ i | } ( A : Type@{ i } )
    : 否定型@{ i } ( 直積型@{ i } A ( 否定型@{ i } A ) )
    :=
        否定型.構築子@{ i }
            ( 直積型@{ i } A ( 否定型@{ i } A ) )
            (
                let
                    a ( z : 直積型@{ i } A ( 否定型@{ i } A ) ) : 空型@{ i }
                        :=
                            否定型.分解子@{ i }
                                A
                                ( 直積型.二番目の区域の分解子@{ i } ( 否定型@{ i } A ) A z )
                                ( 直積型.一番目の区域の分解子@{ i } A ( 否定型@{ i } A ) z )
                in
                    a
            )
.
...
Definition A_2024_08_02_0009@{ i | } ( A : Type@{ i } )
    : 否定型@{ i } ( A_2024_08_02_0004@{ i } A ( 否定型@{ i } A ) )
    :=
        否定型.構築子@{ i }
            ( A_2024_08_02_0004@{ i } A ( 否定型@{ i } A ) )
            (
                let
                    a ( z : A_2024_08_02_0004@{ i } A ( 否定型@{ i } A ) ) : 空型@{ i }
                        :=
                            let
                                a : 否定型@{ i } A
                                    :=
                                                ...
                                                let
                                                    a ( w : A ) : 空型@{ i }
                                                        :=
                                                            否定型.分解子@{ i }
                                                                A
                                                                ( A_2024_08_02_0006@{ i } ( 否定型@{ i } A ) A z w )
                                                                w
                                                in
                                                    a
                                            )
                            in
                                否定型.分解子@{ i } A a ( A_2024_08_02_0007@{ i } A ( 否定型@{ i } A ) z a )
                in
                    a
            )
.
...
Definition A_2024_08_06_0000@{ i | } ( A : Type@{ i } ) ( x : A ) : 否定型@{ i } ( 否定型@{ i } A )
    :=
        否定型.構築子@{ i }
            ( 否定型@{ i } A )
            (
...
Proof .
    ...
    .
    {
        ...
        .
        refine ( 否定型.分解子@{ i } ( 否定型@{ i } A ) z_1 _ ) .
        exact y .
    }
    {
        ...
        .
        refine ( 否定型.分解子@{ i } ( 否定型@{ i } B ) z_2 _ ) .
        exact y .
    }
Defined .
...
Proof .
    ...
    }
    {
        ...
        exact ( A_2024_08_28_0009@{ i } A B z w ) .
    }
Defined .
...
Proof .
    ...
    }
    {
        ...
        .
        refine ( A_2024_08_28_0009@{ i } ( 否定型@{ i } A ) ( 否定型@{ i } B ) _ _ ) .
        {
...
Definition A_2024_07_28_0000@{ i | }
    :
        A_2024_07_22_0009@{ i }
            ...
            A_2024_07_21_0032@{ i }
    := A_2024_07_22_0010@{ i } ゼロから始まる自然数@{ i } A_2024_07_21_0032@{ i }
.

(** ゼロと [x] の後者を足した数は [x] の後者に等しくなります。 *)

Definition A_2024_07_28_0001@{ i | } ( x : ゼロから始まる自然数@{ i } )
    :
        A_2024_07_22_0009@{ i }
            ゼロから始まる自然数@{ i }
            ( A_2024_07_21_0053@{ i } A_2024_07_21_0032@{ i } ( A_2024_07_21_0033@{ i } x ) )
            ( A_2024_07_21_0033@{ i } x )
    := A_2024_07_22_0010@{ i } ゼロから始まる自然数@{ i } ( A_2024_07_21_0033@{ i } x )
.

(** [x] の後者とゼロを足した数は [x] の後者に等しくなります。 *)

Definition A_2024_07_28_0002@{ i | } ( x : ゼロから始まる自然数 )
    :
        A_2024_07_22_0009@{ i }
            ゼロから始まる自然数@{ i }
...
Definition A_2024_07_28_0003@{ i | } ( x : ゼロから始まる自然数@{ i } ) ( y : ゼロから始まる自然数@{ i } )
    :
        A_2024_07_22_0009@{ i }
            ゼロから始まる自然数@{ i }
...
Definition A_2024_07_28_0004@{ i | } ( x : ゼロから始まる自然数@{ i } )
        :
            A_2024_07_22_0009@{ i }
                ゼロから始まる自然数@{ i }
        ...
        return
            A_2024_07_22_0009@{ i }
                ゼロから始まる自然数@{ i }
                    ...
                    x_
        with
            A_2024_07_21_0032 => A_2024_07_22_0010@{ i } ゼロから始まる自然数@{ i } A_2024_07_21_0032@{ i }
            |
            A_2024_07_21_0033 x_前 => A_2024_07_22_0010@{ i } ゼロから始まる自然数@{ i } ( A_2024_07_21_0033@{ i } x_前 )
        end
.

(** [x] とゼロを足した数は [x] に等しくなります。 *)

Definition A_2024_07_28_0005@{ i | } ( x : ゼロから始まる自然数@{ i } )
    :
        A_2024_07_22_0009@{ i }
            ゼロから始まる自然数@{ i }
...
Definition A_2024_07_28_0006@{ i | } ( x : ゼロから始まる自然数@{ i } ) ( y : ゼロから始まる自然数@{ i } )
        :
            A_2024_07_22_0009@{ i }
                ゼロから始まる自然数@{ i }
...
Proof .
    refine
        (
            let
                fix a ( x : ゼロから始まる自然数@{ i } ) ( y : ゼロから始まる自然数@{ i } ) { struct y }
                    :
                        A_2024_07_22_0009@{ i }
                            ゼロから始まる自然数@{ i }
                            ( A_2024_07_21_0053@{ i } ( A_2024_07_21_0033@{ i } x ) y )
    ...
    .
    {
        ...
        .
        {
            exact ( A_2024_07_22_0010@{ i } ゼロから始まる自然数@{ i } ( A_2024_07_21_0033@{ i } A_2024_07_21_0032@{ i } ) ) .
        }
        {
            refine
                (
                    ...
                    refine
                        (
                            A_2024_07_22_0013@{ i }
                                ゼロから始まる自然数@{ i }
                                ゼロから始まる自然数@{ i }
                                ( fun z : ゼロから始まる自然数@{ i } => A_2024_07_21_0033@{ i } ( A_2024_07_21_0033@{ i } z ) )
                                ( A_2024_07_21_0053@{ i } A_2024_07_21_0032@{ i } y_前 )
                                y_前
                                _
                        )
    ...
    }
    {
        ...
        .
        {
            exact ( A_2024_07_22_0010@{ i } ゼロから始まる自然数@{ i } ( A_2024_07_21_0033@{ i } ( A_2024_07_21_0033@{ i } x_前 ) ) ) .
        }
        {
            refine
                (
...
Definition A_2024_08_01_0000@{ i | } ( x : ゼロから始まる自然数@{ i } ) ( y : ゼロから始まる自然数@{ i } )
        :
            A_2024_07_22_0009@{ i }
                ゼロから始まる自然数@{ i }
...
Proof .
    ...
    .
    {
        ...
        {
            exact ( A_2024_07_22_0010@{ i } ゼロから始まる自然数@{ i } ( A_2024_07_21_0033@{ i } ( A_2024_07_21_0033@{ i } y_前 ) ) ) .
        }
    }
    {
        refine
...
Definition A_2024_08_26_0000@{ i | } ( m : ゼロから始まる自然数@{ i } ) ( n : ゼロから始まる自然数@{ i } ) ( o : ゼロから始まる自然数@{ i } )
    :
        A_2024_07_22_0009@{ i }
            ゼロから始まる自然数@{ i }
...
Proof .
    refine
        (
            let
                fix a ( m_ : ゼロから始まる自然数@{ i } ) ( n_ : ゼロから始まる自然数@{ i } ) ( o_ : ゼロから始まる自然数@{ i } ) { struct m_ }
                    :
                        A_2024_07_22_0009@{ i }
                            ゼロから始まる自然数@{ i }
    ...
    .
    {
        ...
        .
        {
            ...
            .
            {
                exact ( A_2024_07_22_0010@{ i } ゼロから始まる自然数@{ i } A_2024_07_21_0032@{ i } ) .
            }
            {
                exact ( A_2024_07_22_0010@{ i } ゼロから始まる自然数@{ i } ( A_2024_07_21_0033@{ i } o_前 ) ) .
            }
        }
        {
            refine
            ...
            .
            {
                exact ( A_2024_07_22_0010@{ i } ゼロから始まる自然数@{ i } ( A_2024_07_21_0033@{ i } n_前 ) ) .
            }
            {
                exact
                    (
    ...
    }
    {
        ...
        .
        {
            ...
            .
            {
                exact ( A_2024_07_22_0010@{ i } ゼロから始まる自然数@{ i } ( A_2024_07_21_0033@{ i } m_前 ) ) .
            }
            {
                exact
                    (
...
Definition A_2024_08_26_0001@{ i | } ( m : ゼロから始まる自然数@{ i } ) ( n : ゼロから始まる自然数@{ i } )
    :
        A_2024_07_22_0009@{ i } ゼロから始まる自然数@{ i } ( A_2024_07_21_0053@{ i } n m ) ( A_2024_07_21_0053@{ i } m n )
.
Proof .
    refine
        (
            let
                fix a ( m_ : ゼロから始まる自然数@{ i } ) ( n_ : ゼロから始まる自然数@{ i } ) { struct m_ }
                    :
                        A_2024_07_22_0009@{ i }
                            ゼロから始まる自然数@{ i }
            ...
            refine
                (
                    A_2024_07_22_0013@{ i }
                        ゼロから始まる自然数@{ i }
                        ゼロから始まる自然数@{ i }
                        ( fun x : ゼロから始まる自然数@{ i } => A_2024_07_21_0033@{ i } ( A_2024_07_21_0033@{ i } x ) )
                        ( A_2024_07_21_0053@{ i } n_前 m_前 )
                        ( A_2024_07_21_0053@{ i } m_前 n_前 )
                        _
                )
