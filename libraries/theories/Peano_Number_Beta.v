...
Definition
  Peano_Number_Beta@{i s_i | i < s_i} : Peano_Number_Tag@{i} -> Type@{i}
    := Peano_Number_Tag.matching_nodep Universe@{i s_i} Peano_Number_Beta_Zero@{i} Peano_Number_Beta_Successor@{i}
.
...
Definition
  zero@{i s_i | i < s_i} (A : Type@{i}) : Peano_Number_Beta Peano_Number_Tag.zero -> A
...
Definition
  succ@{i s_i | i < s_i} (A : Type@{i}) (x_p : A) : Peano_Number_Beta Peano_Number_Tag.succ -> A
